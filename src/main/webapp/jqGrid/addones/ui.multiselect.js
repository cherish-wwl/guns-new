...
$.widget("ui.multiselect", {
  options: {
	...
	_getOptionNode: function(option) {
		option = $(option);
		var node = $('<li class="ui-state-default ui-element" title="'+option.text()+'"><i class="ace-icon fa"/>'+option.text()+'<a href="#" class="action"><i class="ace-icon fa  bigger-50"></i></a></li>').hide();
	...
	_applyItemState: function(item, selected) {
		if (selected) {
			if (this.options.sortable)
				item.children('i').addClass('fa-arrows-v').removeClass('ui-helper-hidden').addClass('fa');
			else
				item.children('i').removeClass('fa-arrows-v').addClass('ui-helper-hidden').removeClass('fa');
			item.find('a.action i').addClass('fa-minus').removeClass('fa-plus');
			this._registerRemoveEvents(item.find('a.action'));

		} else {
			item.children('i').removeClass('fa-arrows-v').addClass('ui-helper-hidden').removeClass('fa');
			item.find('a.action i').addClass('fa-plus').removeClass('fa-minus');
