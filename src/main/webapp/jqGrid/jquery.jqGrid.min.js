...
typeof e?e.match(c):null,c=function(a,c){a=String(a);for(c=parseInt(c,10)||2;a.length<c;)a="0"+a;return a},g={m:1,d:1,y:1970,h:0,i:0,s:0,u:0},k=0,l,m,k=function(a,c){0===a?12===c&&(c=0):12!==c&&(c+=12);return c};void 0===f&&(f=a.jgrid.formatter.date);void 0===f.parseRe&&(f.parseRe=/[#%\\\/:_;.,\t\s-]/);f.masks.hasOwnProperty(d)&&(d=f.masks[d]);if(e&&null!=e)if(isNaN(e-0)||"u"!==String(d).toLowerCase())if(e.constructor===Date)k=e;else if(null!==h){if(k=new Date(parseInt(h[1],10)),h[3]){var p=60*Number(h[5])+
    ...
    6E4*p))}else k=new Date(parseFloat(e));else k=new Date(g.y,g.m,g.d,g.h,g.i,g.s,g.u);if(void 0===b)return k;f.masks.hasOwnProperty(b)?b=f.masks[b]:b||(b="Y-m-d");d=k.getHours();e=k.getMinutes();g=k.getDate();p=k.getMonth()+1;h=k.getTimezoneOffset();l=k.getSeconds();m=k.getMilliseconds();var r=k.getDay(),q=k.getFullYear(),n=(r+6)%7+1,t=(new Date(q,p-1,g)-new Date(q,0,1))/864E5,v={d:c(g),D:f.dayNames[r],j:g,l:f.dayNames[r+7],N:n,S:f.S(g),w:r,z:t,W:5>n?Math.floor((t+n-1)/7)+1:Math.floor((t+n-1)/7)||(4>
((new Date(q-1,0,1)).getDay()+6)%7?53:52),F:f.monthNames[p-1+12],m:c(p),M:f.monthNames[p-1],n:p,t:"?",L:"?",o:"?",Y:q,y:String(q).substring(2),a:12>d?f.AmPm[0]:f.AmPm[1],A:12>d?f.AmPm[2]:f.AmPm[3],B:"?",g:d%12||12,G:d,h:c(d%12||12),H:c(d),i:c(e),s:c(l),u:m,e:"?",I:"?",O:(0<h?"-":"+")+c(100*Math.floor(Math.abs(h)/60)+Math.abs(h)%60,4),P:"?",T:(String(k).match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g)||[""]).pop().replace(/[^-+\dA-Z]/g,
    ""),Z:"?",c:"?",r:"?",U:Math.floor(k/1E3)};return b.replace(/\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g,function(a){return v.hasOwnProperty(a)?v[a]:a.substring(1)})},jqID:function(a){return String(a).replace(/[!"#$%&'()*+,.\/:; <=>?@\[\\\]\^`{|}~]/g,"\\$&")},guid:1,uidPref:"jqg",randId:function(d){return(d||a.jgrid.uidPref)+a.jgrid.guid++},getAccessor:function(a,e){var b,f,c=[],h;if("function"===typeof e)return e(a);b=a[e];if(void 0===b)try{if("string"===typeof e&&(c=e.split(".")),h=c.length)for(b=
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                a;b&&h--;)f=c.shift(),b=b[f]}catch(g){}return b},getXmlData:function(d,e,b){var f="string"===typeof e?e.match(/^(.*)\[(\w+)\]$/):null;if("function"===typeof e)return e(d);if(f&&f[2])return f[1]?a(f[1],d).attr(f[2]):a(d).attr(f[2]);d=a(e,d);return b?d:0<d.length?a(d).text():void 0},cellWidth:function(){var d=a("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div>"),e=d.appendTo("body").find("td").width();
    d.remove();return.1<Math.abs(e-5)},cell_width:!0,ajaxOptions:{},from:function(d){return new function(d,b){"string"===typeof d&&(d=a.data(d));var f=this,c=d,h=!0,g=!1,k=b,l=/[\$,%]/g,m=null,p=null,r=0,q=!1,n="",t=[],v=!0;if("object"===typeof d&&d.push)0<d.length&&(v="object"!==typeof d[0]?!1:!0);else throw"data provides is not an array";this._hasData=function(){return null===c?!1:0===c.length?!1:!0};this._getStr=function(a){var c=[];g&&c.push("jQuery.trim(");c.push("String("+a+")");g&&c.push(")");
    h||c.push(".toLowerCase()");return c.join("")};this._strComp=function(a){return"string"===typeof a?".toString()":""};this._group=function(a,c){return{field:a.toString(),unique:c,items:[]}};this._toStr=function(c){g&&(c=a.trim(c));c=c.toString().replace(/\\/g,"\\\\").replace(/\"/g,'\\"');return h?c:c.toLowerCase()};this._funcLoop=function(b){var d=[];a.each(c,function(a,c){d.push(b(c))});return d};this._append=function(a){var c;k=null===k?"":k+(""===n?" && ":n);for(c=0;c<r;c++)k+="(";q&&(k+="!");k+=
    "("+a+")";q=!1;n="";r=0};this._setCommand=function(a,c){m=a;p=c};this._resetNegate=function(){q=!1};this._repeatCommand=function(a,c){return null===m?f:null!==a&&null!==c?m(a,c):null!==p&&v?m(p,a):m(a)};this._equals=function(a,c){return 0===f._compare(a,c,1)};this._compare=function(a,c,b){var d=Object.prototype.toString;void 0===b&&(b=1);void 0===a&&(a=null);void 0===c&&(c=null);if(null===a&&null===c)return 0;if(null===a&&null!==c)return 1;if(null!==a&&null===c)return-1;if("[object Date]"===d.call(a)&&
    "[object Date]"===d.call(c))return a<c?-b:a>c?b:0;h||"number"===typeof a||"number"===typeof c||(a=String(a),c=String(c));return a<c?-b:a>c?b:0};this._performSort=function(){0!==t.length&&(c=f._doSort(c,0))};this._doSort=function(a,c){var b=t[c].by,d=t[c].dir,e=t[c].type,g=t[c].datefmt,h=t[c].sfunc;if(c===t.length-1)return f._getOrder(a,b,d,e,g,h);c++;b=f._getGroup(a,b,d,e,g);d=[];for(e=0;e<b.length;e++)for(h=f._doSort(b[e].items,c),g=0;g<h.length;g++)d.push(h[g]);return d};this._getOrder=function(c,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          b,d,e,g,k){var m=[],r=[],p="a"===d?1:-1,n,q;void 0===e&&(e="text");q="float"===e||"number"===e||"currency"===e||"numeric"===e?function(a){a=parseFloat(String(a).replace(l,""));return isNaN(a)?0:a}:"int"===e||"integer"===e?function(a){return a?parseFloat(String(a).replace(l,"")):0}:"date"===e||"datetime"===e?function(c){return a.jgrid.parseDate(g,c).getTime()}:a.isFunction(e)?e:function(c){c=c?a.trim(String(c)):"";return h?c:c.toLowerCase()};a.each(c,function(c,d){n=""!==b?a.jgrid.getAccessor(d,b):
    d;void 0===n&&(n="");n=q(n,d);r.push({vSort:n,index:c})});a.isFunction(k)?r.sort(function(a,c){a=a.vSort;c=c.vSort;return k.call(this,a,c,p)}):r.sort(function(a,c){a=a.vSort;c=c.vSort;return f._compare(a,c,p)});e=0;for(var t=c.length;e<t;)d=r[e].index,m.push(c[d]),e++;return m};this._getGroup=function(c,b,d,e,g){var h=[],k=null,l=null,m;a.each(f._getOrder(c,b,d,e,g),function(c,d){m=a.jgrid.getAccessor(d,b);null==m&&(m="");f._equals(l,m)||(l=m,null!==k&&h.push(k),k=f._group(b,m));k.items.push(d)});
    null!==k&&h.push(k);return h};this.ignoreCase=function(){h=!1;return f};this.useCase=function(){h=!0;return f};this.trim=function(){g=!0;return f};this.noTrim=function(){g=!1;return f};this.execute=function(){var b=k,d=[];if(null===b)return f;a.each(c,function(){eval(b)&&d.push(this)});c=d;return f};this.data=function(){return c};this.select=function(b){f._performSort();if(!f._hasData())return[];f.execute();if(a.isFunction(b)){var d=[];a.each(c,function(a,c){d.push(b(c))});return d}return c};this.hasMatch=
    function(){if(!f._hasData())return!1;f.execute();return 0<c.length};this.andNot=function(a,c,b){q=!q;return f.and(a,c,b)};this.orNot=function(a,c,b){q=!q;return f.or(a,c,b)};this.not=function(a,c,b){return f.andNot(a,c,b)};this.and=function(a,c,b){n=" && ";return void 0===a?f:f._repeatCommand(a,c,b)};this.or=function(a,c,b){n=" || ";return void 0===a?f:f._repeatCommand(a,c,b)};this.orBegin=function(){r++;return f};this.orEnd=function(){null!==k&&(k+=")");return f};this.isNot=function(a){q=!q;return f.is(a)};
    this.is=function(a){f._append("this."+a);f._resetNegate();return f};this._compareValues=function(c,b,d,e,g){var h;h=v?"jQuery.jgrid.getAccessor(this,'"+b+"')":"this";void 0===d&&(d=null);var k=d,m=void 0===g.stype?"text":g.stype;if(null!==d)switch(m){case "int":case "integer":k=isNaN(Number(k))||""===k?"0":k;h="parseInt("+h+",10)";k="parseInt("+k+",10)";break;case "float":case "number":case "numeric":k=String(k).replace(l,"");k=isNaN(Number(k))||""===k?"0":k;h="parseFloat("+h+")";k="parseFloat("+
        k+")";break;case "date":case "datetime":k=String(a.jgrid.parseDate(g.newfmt||"Y-m-d",k).getTime());h='jQuery.jgrid.parseDate("'+g.srcfmt+'",'+h+").getTime()";break;default:h=f._getStr(h),k=f._getStr('"'+f._toStr(k)+'"')}f._append(h+" "+e+" "+k);f._setCommand(c,b);f._resetNegate();return f};this.equals=function(a,c,b){return f._compareValues(f.equals,a,c,"==",b)};this.notEquals=function(a,c,b){return f._compareValues(f.equals,a,c,"!==",b)};this.isNull=function(a,c,b){return f._compareValues(f.equals,
        a,null,"===",b)};this.greater=function(a,c,b){return f._compareValues(f.greater,a,c,">",b)};this.less=function(a,c,b){return f._compareValues(f.less,a,c,"<",b)};this.greaterOrEquals=function(a,c,b){return f._compareValues(f.greaterOrEquals,a,c,">=",b)};this.lessOrEquals=function(a,c,b){return f._compareValues(f.lessOrEquals,a,c,"<=",b)};this.startsWith=function(c,b){var d=null==b?c:b,d=g?a.trim(d.toString()).length:d.toString().length;v?f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+c+"')")+
        ".substr(0,"+d+") == "+f._getStr('"'+f._toStr(b)+'"')):(null!=b&&(d=g?a.trim(b.toString()).length:b.toString().length),f._append(f._getStr("this")+".substr(0,"+d+") == "+f._getStr('"'+f._toStr(c)+'"')));f._setCommand(f.startsWith,c);f._resetNegate();return f};this.endsWith=function(c,b){var d=null==b?c:b,d=g?a.trim(d.toString()).length:d.toString().length;v?f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+c+"')")+".substr("+f._getStr("jQuery.jgrid.getAccessor(this,'"+c+"')")+".length-"+d+","+
        d+') == "'+f._toStr(b)+'"'):f._append(f._getStr("this")+".substr("+f._getStr("this")+'.length-"'+f._toStr(c)+'".length,"'+f._toStr(c)+'".length) == "'+f._toStr(c)+'"');f._setCommand(f.endsWith,c);f._resetNegate();return f};this.contains=function(a,c){v?f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+a+"')")+'.indexOf("'+f._toStr(c)+'",0) > -1'):f._append(f._getStr("this")+'.indexOf("'+f._toStr(a)+'",0) > -1');f._setCommand(f.contains,a);f._resetNegate();return f};this.groupBy=function(a,b,d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        e){return f._hasData()?f._getGroup(c,a,b,d,e):null};this.orderBy=function(c,b,d,e,g){b=null==b?"a":a.trim(b.toString().toLowerCase());null==d&&(d="text");null==e&&(e="Y-m-d");null==g&&(g=!1);if("desc"===b||"descending"===b)b="d";if("asc"===b||"ascending"===b)b="a";t.push({by:c,dir:b,type:d,datefmt:e,sfunc:g});return f};return f}(d,null)},getMethod:function(d){return this.getAccessor(a.fn.jqGrid,d)},extend:function(d){a.extend(a.fn.jqGrid,d);this.no_legacy_api||a.fn.extend(d)}});a.fn.jqGrid=function(d){if("string"===
    ...
    k;var m=b.rowNum;g=e.scrollTop=e.bDiv.scrollTop;var r=Math.round(d.position().top)-g,p=r+d.height();k*=m;var n,q,t;p<c&&0>=r&&(void 0===b.lastpage||parseInt((p+g+k-1)/k,10)<=b.lastpage)&&(q=parseInt((c-p+k-1)/k,10),0<=p||2>q||!0===b.scroll?(n=Math.round((p+g)/k)+1,r=-1):r=1);0<r&&(n=parseInt(g/k,10)+1,q=parseInt((g+c)/k,10)+2-n,t=!0);!q||b.lastpage&&(n>b.lastpage||1===b.lastpage||n===b.page&&n===b.lastpage)||(e.hDiv.loading?e.timer=setTimeout(e.populateVisible,b.scrollTimeout):(b.page=n,t&&(e.selectionPreserver(d[0]),
    ...
    var p=a("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");a(p).attr({id:"gbox_"+this.id,dir:k}).insertBefore(l);a(l).attr("id","gview_"+this.id).appendTo(p);a("<div class='ui-widget-overlay jqgrid-overlay' id='lui_"+this.id+"'></div>").insertBefore(l);a("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'>"+this.p.loadtext+"</div>").insertBefore(l);a(this).attr({cellspacing:"0",cellpadding:"0",border:"0",role:"grid","aria-multiselectable":!!this.p.multiselect,
        "aria-labelledby":"gbox_"+this.id});var r=function(a,c){a=parseInt(a,10);return isNaN(a)?c||0:a},q=function(b,d,f,g,k,l){var m=c.p.colModel[b],r=m.align,p='style="',n=m.classes,q=m.name,t=[];r&&(p+="text-align:"+r+";");!0===m.hidden&&(p+="display:none;");if(0===d)p+="width: "+e.headers[b].width+"px;";else if(m.cellattr&&a.isFunction(m.cellattr)&&(b=m.cellattr.call(c,k,f,g,m,l))&&"string"===typeof b)if(b=b.replace(/style/i,"style").replace(/title/i,"title"),-1<b.indexOf("title")&&(m.title=!1),-1<b.indexOf("class")&&
            (n=void 0),t=b.replace("-style","-sti").split(/style/),2===t.length){t[1]=a.trim(t[1].replace("-sti","-style").replace("=",""));if(0===t[1].indexOf("'")||0===t[1].indexOf('"'))t[1]=t[1].substring(1);p+=t[1].replace(/'/gi,'"')}else p+='"';t.length||(t[0]="",p+='"');p+=(void 0!==n?' class="'+n+'"':"")+(m.title&&f?' title="'+a.jgrid.stripHtml(f)+'"':"");p+=' aria-describedby="'+c.p.id+"_"+q+'"';return p+t[0]},n=function(b){return null==b||""===b?"&#160;":c.p.autoencode?a.jgrid.htmlEncode(b):String(b)},
        t=function(b,d,e,f,g){var k=c.p.colModel[e];void 0!==k.formatter?(b=""!==String(c.p.idPrefix)?a.jgrid.stripPref(c.p.idPrefix,b):b,b={rowId:b,colModel:k,gid:c.p.id,pos:e},d=a.isFunction(k.formatter)?k.formatter.call(c,d,b,f,g):a.fmatter?a.fn.fmatter.call(c,k.formatter,d,b,f,g):n(d)):d=n(d);return d},v=function(a,c,b,d,e,f){c=t(a,c,b,e,"add");return'<td role="gridcell" '+q(b,d,c,e,a,f)+">"+c+"</td>"},w=function(a,b,d,e){e='<input role="checkbox" type="checkbox" id="jqg_'+c.p.id+"_"+a+'" class="cbox" name="jqg_'+
            c.p.id+"_"+a+'"'+(e?'checked="checked"':"")+"/>";return'<td role="gridcell" '+q(b,d,"",null,a,!0)+">"+e+"</td>"},u=function(a,c,b,d){b=(parseInt(b,10)-1)*parseInt(d,10)+1+c;return'<td role="gridcell" class="ui-state-default jqgrid-rownum" '+q(a,c,b,null,c,!0)+">"+b+"</td>"},x=function(a){var b,d=[],e=0,f;for(f=0;f<c.p.colModel.length;f++)b=c.p.colModel[f],"cb"!==b.name&&"subgrid"!==b.name&&"rn"!==b.name&&(d[e]="local"===a?b.name:"xml"===a||"xmlstring"===a?b.xmlmap||b.name:b.jsonmap||b.name,!1!==c.p.keyIndex&&
        !0===b.key&&(c.p.keyName=d[e]),e++);return d},y=function(b){var d=c.p.remapColumns;d&&d.length||(d=a.map(c.p.colModel,function(a,c){return c}));b&&(d=a.map(d,function(a){return a<b?null:a-b}));return d},A=function(c,b){var d;this.p.deepempty?a(this.rows).slice(1).remove():(d=0<this.rows.length?this.rows[0]:null,a(this.firstChild).empty().append(d));c&&this.p.scroll&&(a(this.grid.bDiv.firstChild).css({height:"auto"}),a(this.grid.bDiv.firstChild.firstChild).css({height:0,display:"none"}),0!==this.grid.bDiv.scrollTop&&
        (this.grid.bDiv.scrollTop=0));!0===b&&this.p.treeGrid&&(this.p.data=[],this.p._index={})},B=function(){var b=c.p.data.length,d,e,f;d=!0===c.p.rownumbers?1:0;e=!0===c.p.multiselect?1:0;f=!0===c.p.subGrid?1:0;d=!1===c.p.keyIndex||!0===c.p.loadonce?c.p.localReader.id:c.p.colModel[c.p.keyIndex+e+f+d].name;for(e=0;e<b;e++)f=a.jgrid.getAccessor(c.p.data[e],d),void 0===f&&(f=String(e+1)),c.p._index[f]=e},J=function(b,d,e,f,g,k){var l="-1",h="",m;d=d?"display:none;":"";e="ui-widget-content jqgrow ui-row-"+
            ...
            m+"="+k[m])}return'<tr role="row" id="'+b+'" tabindex="'+l+'" class="'+e+'"'+(""===d?"":' style="'+d+'"')+h+">"},C=function(b,d,e,f,g){var k=new Date,l="local"!==c.p.datatype&&c.p.loadonce||"xmlstring"===c.p.datatype,h=c.p.xmlReader,m="local"===c.p.datatype?"local":"xml";l&&(c.p.data=[],c.p._index={},c.p.localReader.id="_id_");c.p.reccount=0;if(a.isXMLDoc(b)){-1!==c.p.treeANode||c.p.scroll?e=1<e?e:1:(A.call(c,!1,!0),e=1);var p=a(c),n,q,t=0,C,I=!0===c.p.multiselect?1:0,B=0,z,L=!0===c.p.rownumbers?
            1:0,M,H=[],K,E={},O,F,G=[],S=!0===c.p.altRows?c.p.altclass:"",ha;!0===c.p.subGrid&&(B=1,z=a.jgrid.getMethod("addSubGridCell"));h.repeatitems||(H=x(m));M=!1===c.p.keyIndex?a.isFunction(h.id)?h.id.call(c,b):h.id:c.p.keyIndex;0<H.length&&!isNaN(M)&&(M=c.p.keyName);m=-1===String(M).indexOf("[")?H.length?function(c,b){return a(M,c).text()||b}:function(c,b){return a(h.cell,c).eq(M).text()||b}:function(a,c){return a.getAttribute(M.replace(/[\[\]]/g,""))||c};c.p.userData={};c.p.page=r(a.jgrid.getXmlData(b,
            h.page),c.p.page);c.p.lastpage=r(a.jgrid.getXmlData(b,h.total),1);c.p.records=r(a.jgrid.getXmlData(b,h.records));a.isFunction(h.userdata)?c.p.userData=h.userdata.call(c,b)||{}:a.jgrid.getXmlData(b,h.userdata,!0).each(function(){c.p.userData[this.getAttribute("name")]=a(this).text()});b=a.jgrid.getXmlData(b,h.root,!0);(b=a.jgrid.getXmlData(b,h.row,!0))||(b=[]);var R=b.length,D=0,N=[],U=parseInt(c.p.rowNum,10),aa=c.p.scroll?a.jgrid.randId():1;0<R&&0>=c.p.page&&(c.p.page=1);if(b&&R){g&&(U*=g+1);g=a.isFunction(c.p.afterInsertRow);
            var V=!1,T;c.p.grouping&&(V=!0===c.p.groupingView.groupCollapse,T=a.jgrid.getMethod("groupingPrepare"));for(;D<R;){O=b[D];F=m(O,aa+D);F=c.p.idPrefix+F;n=0===e?0:e+1;ha=1===(n+D)%2?S:"";var Q=G.length;G.push("");L&&G.push(u(0,D,c.p.page,c.p.rowNum));I&&G.push(w(F,L,D,!1));B&&G.push(z.call(p,I+L,D+e));if(h.repeatitems){K||(K=y(I+B+L));var Z=a.jgrid.getXmlData(O,h.cell,!0);a.each(K,function(a){var b=Z[this];if(!b)return!1;C=b.textContent||b.text;E[c.p.colModel[a+I+B+L].name]=C;G.push(v(F,C,a+I+B+L,D+
                e,O,E))})}else for(n=0;n<H.length;n++)C=a.jgrid.getXmlData(O,H[n]),E[c.p.colModel[n+I+B+L].name]=C,G.push(v(F,C,n+I+B+L,D+e,O,E));G[Q]=J(F,V,ha,E,O,!1);G.push("</tr>");c.p.grouping&&(N.push(G),c.p.groupingView._locgr||T.call(p,E,D),G=[]);if(l||!0===c.p.treeGrid)E._id_=a.jgrid.stripPref(c.p.idPrefix,F),c.p.data.push(E),c.p._index[E._id_]=c.p.data.length-1;!1===c.p.gridview&&(a("tbody:first",d).append(G.join("")),p.triggerHandler("jqGridAfterInsertRow",[F,E,O]),g&&c.p.afterInsertRow.call(c,F,E,O),G=
                []);E={};t++;D++;if(t===U)break}}!0===c.p.gridview&&(q=-1<c.p.treeANode?c.p.treeANode:0,c.p.grouping?(l||p.jqGrid("groupingRender",N,c.p.colModel.length,c.p.page,U),N=null):!0===c.p.treeGrid&&0<q?a(c.rows[q]).after(G.join("")):a("tbody:first",d).append(G.join("")));if(!0===c.p.subGrid)try{p.jqGrid("addSubGrid",I+L)}catch(ca){}c.p.totaltime=new Date-k;0<t&&0===c.p.records&&(c.p.records=R);G=null;if(!0===c.p.treeGrid)try{p.jqGrid("setTreeNode",q+1,t+q+1)}catch(P){}c.p.treeGrid||c.p.scroll||(c.grid.bDiv.scrollTop=
            0);c.p.reccount=t;c.p.treeANode=-1;c.p.userDataOnFooter&&p.jqGrid("footerData","set",c.p.userData,!0);l&&(c.p.records=R,c.p.lastpage=Math.ceil(R/U));f||c.updatepager(!1,!0);if(l){for(;t<R;){O=b[t];F=m(O,t+aa);F=c.p.idPrefix+F;if(h.repeatitems){K||(K=y(I+B+L));var ga=a.jgrid.getXmlData(O,h.cell,!0);a.each(K,function(a){var b=ga[this];if(!b)return!1;C=b.textContent||b.text;E[c.p.colModel[a+I+B+L].name]=C})}else for(n=0;n<H.length;n++)C=a.jgrid.getXmlData(O,H[n]),E[c.p.colModel[n+I+B+L].name]=C;E._id_=
            a.jgrid.stripPref(c.p.idPrefix,F);c.p.grouping&&T.call(p,E,t);c.p.data.push(E);c.p._index[E._id_]=c.p.data.length-1;E={};t++}c.p.grouping&&(c.p.groupingView._locgr=!0,p.jqGrid("groupingRender",N,c.p.colModel.length,c.p.page,U),N=null)}}},M=function(b,d,e,f,g){var k=new Date;if(b){-1!==c.p.treeANode||c.p.scroll?e=1<e?e:1:(A.call(c,!1,!0),e=1);var h,l="local"!==c.p.datatype&&c.p.loadonce||"jsonstring"===c.p.datatype;l&&(c.p.data=[],c.p._index={},c.p.localReader.id="_id_");c.p.reccount=0;"local"===c.p.datatype?
            (d=c.p.localReader,h="local"):(d=c.p.jsonReader,h="json");var m=a(c),p=0,n,q,t,C=[],I=c.p.multiselect?1:0,B=!0===c.p.subGrid?1:0,z,L=!0===c.p.rownumbers?1:0,M=y(I+B+L);h=x(h);var E,H,G,K={},O,F,D=[],ha=!0===c.p.altRows?c.p.altclass:"",R;c.p.page=r(a.jgrid.getAccessor(b,d.page),c.p.page);c.p.lastpage=r(a.jgrid.getAccessor(b,d.total),1);c.p.records=r(a.jgrid.getAccessor(b,d.records));c.p.userData=a.jgrid.getAccessor(b,d.userdata)||{};B&&(z=a.jgrid.getMethod("addSubGridCell"));G=!1===c.p.keyIndex?a.isFunction(d.id)?
            d.id.call(c,b):d.id:c.p.keyIndex;d.repeatitems||(C=h,0<C.length&&!isNaN(G)&&(G=c.p.keyName));H=a.jgrid.getAccessor(b,d.root);null==H&&a.isArray(b)&&(H=b);H||(H=[]);b=H.length;q=0;0<b&&0>=c.p.page&&(c.p.page=1);var S=parseInt(c.p.rowNum,10),N=c.p.scroll?a.jgrid.randId():1,U=!1,T;g&&(S*=g+1);"local"!==c.p.datatype||c.p.deselectAfterSort||(U=!0);var aa=a.isFunction(c.p.afterInsertRow),V=[],Q=!1,Z;c.p.grouping&&(Q=!0===c.p.groupingView.groupCollapse,Z=a.jgrid.getMethod("groupingPrepare"));for(;q<b;){g=
            H[q];F=a.jgrid.getAccessor(g,G);void 0===F&&("number"===typeof G&&null!=c.p.colModel[G+I+B+L]&&(F=a.jgrid.getAccessor(g,c.p.colModel[G+I+B+L].name)),void 0===F&&(F=N+q,0===C.length&&d.cell&&(n=a.jgrid.getAccessor(g,d.cell)||g,F=null!=n&&void 0!==n[G]?n[G]:F)));F=c.p.idPrefix+F;n=1===e?0:e;R=1===(n+q)%2?ha:"";U&&(T=c.p.multiselect?-1!==a.inArray(F,c.p.selarrrow):F===c.p.selrow);var ca=D.length;D.push("");L&&D.push(u(0,q,c.p.page,c.p.rowNum));I&&D.push(w(F,L,q,T));B&&D.push(z.call(m,I+L,q+e));E=h;d.repeatitems&&
        (d.cell&&(g=a.jgrid.getAccessor(g,d.cell)||g),a.isArray(g)&&(E=M));for(t=0;t<E.length;t++)n=a.jgrid.getAccessor(g,E[t]),K[c.p.colModel[t+I+B+L].name]=n,D.push(v(F,n,t+I+B+L,q+e,g,K));D[ca]=J(F,Q,R,K,g,T);D.push("</tr>");c.p.grouping&&(V.push(D),c.p.groupingView._locgr||Z.call(m,K,q),D=[]);if(l||!0===c.p.treeGrid)K._id_=a.jgrid.stripPref(c.p.idPrefix,F),c.p.data.push(K),c.p._index[K._id_]=c.p.data.length-1;!1===c.p.gridview&&(a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(D.join("")),m.triggerHandler("jqGridAfterInsertRow",
            [F,K,g]),aa&&c.p.afterInsertRow.call(c,F,K,g),D=[]);K={};p++;q++;if(p===S)break}!0===c.p.gridview&&(O=-1<c.p.treeANode?c.p.treeANode:0,c.p.grouping?l||(m.jqGrid("groupingRender",V,c.p.colModel.length,c.p.page,S),V=null):!0===c.p.treeGrid&&0<O?a(c.rows[O]).after(D.join("")):a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(D.join("")));if(!0===c.p.subGrid)try{m.jqGrid("addSubGrid",I+L)}catch(P){}c.p.totaltime=new Date-k;0<p&&0===c.p.records&&(c.p.records=b);if(!0===c.p.treeGrid)try{m.jqGrid("setTreeNode",
            O+1,p+O+1)}catch(ga){}c.p.treeGrid||c.p.scroll||(c.grid.bDiv.scrollTop=0);c.p.reccount=p;c.p.treeANode=-1;c.p.userDataOnFooter&&m.jqGrid("footerData","set",c.p.userData,!0);l&&(c.p.records=b,c.p.lastpage=Math.ceil(b/S));f||c.updatepager(!1,!0);if(l){for(;p<b&&H[p];){g=H[p];F=a.jgrid.getAccessor(g,G);void 0===F&&("number"===typeof G&&null!=c.p.colModel[G+I+B+L]&&(F=a.jgrid.getAccessor(g,c.p.colModel[G+I+B+L].name)),void 0===F&&(F=N+p,0===C.length&&d.cell&&(e=a.jgrid.getAccessor(g,d.cell)||g,F=null!=
        e&&void 0!==e[G]?e[G]:F)));if(g){F=c.p.idPrefix+F;E=h;d.repeatitems&&(d.cell&&(g=a.jgrid.getAccessor(g,d.cell)||g),a.isArray(g)&&(E=M));for(t=0;t<E.length;t++)K[c.p.colModel[t+I+B+L].name]=a.jgrid.getAccessor(g,E[t]);K._id_=a.jgrid.stripPref(c.p.idPrefix,F);c.p.grouping&&Z.call(m,K,p);c.p.data.push(K);c.p._index[K._id_]=c.p.data.length-1;K={}}p++}c.p.grouping&&(c.p.groupingView._locgr=!0,m.jqGrid("groupingRender",V,c.p.colModel.length,c.p.page,S))}}},H=function(){function b(a){var c=0,d,e,f,k,h;if(null!=
            a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&v.orBegin();for(d=0;d<a.groups.length;d++){0<c&&e&&v.or();try{b(a.groups[d])}catch(l){alert(l)}c++}e&&v.orEnd()}if(null!=a.rules)try{(f=a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&v.orBegin();for(d=0;d<a.rules.length;d++)h=a.rules[d],k=a.groupOp.toString().toUpperCase(),t[h.op]&&h.field&&(0<c&&k&&"OR"===k&&(v=v.or()),v=t[h.op](v,k)(h.field,h.data,g[h.field])),c++;f&&v.orEnd()}catch(m){alert(m)}}var d=c.p.multiSort?
            ...
            g[d].stype||"text",g[d].srcfmt||"");else{var t={eq:function(a){return a.equals},ne:function(a){return a.notEquals},lt:function(a){return a.less},le:function(a){return a.lessOrEquals},gt:function(a){return a.greater},ge:function(a){return a.greaterOrEquals},cn:function(a){return a.contains},nc:function(a,c){return"OR"===c?a.orNot().contains:a.andNot().contains},bw:function(a){return a.startsWith},bn:function(a,c){return"OR"===c?a.orNot().startsWith:a.andNot().startsWith},en:function(a,c){return"OR"===
        c?a.orNot().endsWith:a.andNot().endsWith},ew:function(a){return a.endsWith},ni:function(a,c){return"OR"===c?a.orNot().equals:a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,c){return"OR"===c?a.orNot().isNull:a.andNot().isNull}},v=a.jgrid.from(c.p.data);c.p.ignoreCase&&(v=v.ignoreCase());if(!0===c.p.search){var x=c.p.postData.filters;if(x)"string"===typeof x&&(x=a.jgrid.parse(x)),b(x);else try{v=t[c.p.postData.searchOper](v)(c.p.postData.searchField,
            c.p.postData.searchString,g[c.p.postData.searchField])}catch(w){}}if(c.p.grouping)for(q=0;q<r;q++)v.orderBy(h[q],n.groupOrder[q],k[q].stype,k[q].srcfmt);c.p.multiSort?a.each(d,function(a){v.orderBy(this,e[a],g[this].stype,g[this].srcfmt,g[this].sfunc)}):d&&c.p.sortorder&&f&&("DESC"===c.p.sortorder.toUpperCase()?v.orderBy(c.p.sortname,"d",g[d].stype,g[d].srcfmt,g[d].sfunc):v.orderBy(c.p.sortname,"a",g[d].stype,g[d].srcfmt,g[d].sfunc));var x=v.select(),u=parseInt(c.p.rowNum,10),y=x.length,I=parseInt(c.p.page,
            10),C=Math.ceil(y/u),B={};if((c.p.search||c.p.resetsearch)&&c.p.grouping&&c.p.groupingView._locgr){c.p.groupingView.groups=[];var A,z=a.jgrid.getMethod("groupingPrepare"),L,J;if(c.p.footerrow&&c.p.userDataOnFooter){for(L in c.p.userData)c.p.userData.hasOwnProperty(L)&&(c.p.userData[L]=0);J=!0}for(A=0;A<y;A++){if(J)for(L in c.p.userData)c.p.userData[L]+=parseFloat(x[A][L]||0);z.call(a(c),x[A],A,u)}}x=x.slice((I-1)*u,I*u);g=v=null;B[c.p.localReader.total]=C;B[c.p.localReader.page]=I;B[c.p.localReader.records]=
            y;B[c.p.localReader.root]=x;B[c.p.localReader.userdata]=c.p.userData;x=null;return B}}},z=function(){c.grid.hDiv.loading=!0;if(!c.p.hiddengrid)switch(c.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(c.p.id)).show();break;case "block":a("#lui_"+a.jgrid.jqID(c.p.id)).show(),a("#load_"+a.jgrid.jqID(c.p.id)).show()}},E=function(){c.grid.hDiv.loading=!1;switch(c.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(c.p.id)).hide();break;case "block":a("#lui_"+a.jgrid.jqID(c.p.id)).hide(),a("#load_"+a.jgrid.jqID(c.p.id)).hide()}},
        D=function(b){if(!c.grid.hDiv.loading){var d=c.p.scroll&&!1===b,e={},f,g=c.p.prmNames;0>=c.p.page&&(c.p.page=Math.min(1,c.p.lastpage));null!==g.search&&(e[g.search]=c.p.search);null!==g.nd&&(e[g.nd]=(new Date).getTime());null!==g.rows&&(e[g.rows]=c.p.rowNum);null!==g.page&&(e[g.page]=c.p.page);null!==g.sort&&(e[g.sort]=c.p.sortname);null!==g.order&&(e[g.order]=c.p.sortorder);null!==c.p.rowTotal&&null!==g.totalrows&&(e[g.totalrows]=c.p.rowTotal);var k=a.isFunction(c.p.loadComplete),h=k?c.p.loadComplete:
            null,l=0;b=b||1;1<b?null!==g.npage?(e[g.npage]=b,l=b-1,b=1):h=function(a){c.p.page++;c.grid.hDiv.loading=!1;k&&c.p.loadComplete.call(c,a);D(b-1)}:null!==g.npage&&delete c.p.postData[g.npage];if(c.p.grouping){a(c).jqGrid("groupingSetup");var m=c.p.groupingView,p,n="";for(p=0;p<m.groupField.length;p++){var r=m.groupField[p];a.each(c.p.colModel,function(a,c){c.name===r&&c.index&&(r=c.index)});n+=r+" "+m.groupOrder[p]+", "}e[g.sort]=n+e[g.sort]}a.extend(c.p.postData,e);var q=c.p.scroll?c.rows.length-
        1:1,e=a(c).triggerHandler("jqGridBeforeRequest");if(!1!==e&&"stop"!==e)if(a.isFunction(c.p.datatype))c.p.datatype.call(c,c.p.postData,"load_"+c.p.id,q,b,l);else{if(a.isFunction(c.p.beforeRequest)&&(e=c.p.beforeRequest.call(c),void 0===e&&(e=!0),!1===e))return;f=c.p.datatype.toLowerCase();switch(f){case "json":case "jsonp":case "xml":case "script":a.ajax(a.extend({url:c.p.url,type:c.p.mtype,dataType:f,data:a.isFunction(c.p.serializeGridData)?c.p.serializeGridData.call(c,c.p.postData):c.p.postData,
            success:function(e,g,k){if(a.isFunction(c.p.beforeProcessing)&&!1===c.p.beforeProcessing.call(c,e,g,k))E();else{"xml"===f?C(e,c.grid.bDiv,q,1<b,l):M(e,c.grid.bDiv,q,1<b,l);a(c).triggerHandler("jqGridLoadComplete",[e]);h&&h.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);d&&c.grid.populateVisible();if(c.p.loadonce||c.p.treeGrid)c.p.datatype="local";1===b&&E()}},error:function(d,e,f){a.isFunction(c.p.loadError)&&c.p.loadError.call(c,d,e,f);1===b&&E()},beforeSend:function(b,d){var e=!0;
                a.isFunction(c.p.loadBeforeSend)&&(e=c.p.loadBeforeSend.call(c,b,d));void 0===e&&(e=!0);if(!1===e)return!1;z()}},a.jgrid.ajaxOptions,c.p.ajaxGridOptions));break;case "xmlstring":z();e="string"!==typeof c.p.datastr?c.p.datastr:a.parseXML(c.p.datastr);C(e,c.grid.bDiv);a(c).triggerHandler("jqGridLoadComplete",[e]);k&&c.p.loadComplete.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);c.p.datatype="local";c.p.datastr=null;E();break;case "jsonstring":z();e="string"===typeof c.p.datastr?a.jgrid.parse(c.p.datastr):
            c.p.datastr;M(e,c.grid.bDiv);a(c).triggerHandler("jqGridLoadComplete",[e]);k&&c.p.loadComplete.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);c.p.datatype="local";c.p.datastr=null;E();break;case "local":case "clientside":z(),c.p.datatype="local",e=H(),M(e,c.grid.bDiv,q,1<b,l),a(c).triggerHandler("jqGridLoadComplete",[e]),h&&h.call(c,e),a(c).triggerHandler("jqGridAfterLoadComplete",[e]),d&&c.grid.populateVisible(),E()}}}},Q=function(b){a("#cb_"+a.jgrid.jqID(c.p.id),c.grid.hDiv)[c.p.useProp?
            "prop":"attr"]("checked",b);if(c.p.frozenColumns&&c.p.id+"_frozen")a("#cb_"+a.jgrid.jqID(c.p.id),c.grid.fhDiv)[c.p.useProp?"prop":"attr"]("checked",b)},W=function(b,d){var e="",f="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",g="",h,l,m,p,n=function(b){var d;a.isFunction(c.p.onPaging)&&(d=c.p.onPaging.call(c,b));if("stop"===d)return!1;c.p.selrow=null;c.p.multiselect&&(c.p.selarrrow=[],Q(!1));c.p.savedRow=[];return!0};b=b.substr(1);d+=
            ...
            "11px";a(document.body).append("<div id='testpg' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+g+";visibility:hidden;' ></div>");f=a(f).clone().appendTo("#testpg").width();a("#testpg").remove();0<f&&(""!==e&&(f+=50),a("td#"+b+"_"+c.p.pagerpos,"#"+h).width(f));c.p._nvtd=[];c.p._nvtd[0]=f?Math.floor((c.p.width-f)/2):Math.floor(c.p.width/3);c.p._nvtd[1]=0;f=null;a(".ui-pg-selbox","#"+h).bind("change",function(){if(!n("records"))return!1;c.p.page=Math.round(c.p.rowNum*(c.p.page-1)/
                this.value-.5)+1;c.p.rowNum=this.value;c.p.pager&&a(".ui-pg-selbox",c.p.pager).val(this.value);c.p.toppager&&a(".ui-pg-selbox",c.p.toppager).val(this.value);D();return!1});!0===c.p.pgbuttons&&(a(".ui-pg-button","#"+h).hover(function(){a(this).hasClass("ui-state-disabled")?this.style.cursor="default":(a(this).addClass("ui-state-hover"),this.style.cursor="pointer")},function(){a(this).hasClass("ui-state-disabled")||(a(this).removeClass("ui-state-hover"),this.style.cursor="default")}),a("#first"+a.jgrid.jqID(d)+
            ", #prev"+a.jgrid.jqID(d)+", #next"+a.jgrid.jqID(d)+", #last"+a.jgrid.jqID(d)).click(function(){if(a(this).hasClass("ui-state-disabled"))return!1;var b=r(c.p.page,1),e=r(c.p.lastpage,1),f=!1,g=!0,k=!0,h=!0,l=!0;0===e||1===e?l=h=k=g=!1:1<e&&1<=b?1===b?k=g=!1:b===e&&(l=h=!1):1<e&&0===b&&(l=h=!1,b=e-1);if(!n(this.id))return!1;this.id==="first"+d&&g&&(c.p.page=1,f=!0);this.id==="prev"+d&&k&&(c.p.page=b-1,f=!0);this.id==="next"+d&&h&&(c.p.page=b+1,f=!0);this.id==="last"+d&&l&&(c.p.page=e,f=!0);f&&D();
            return!1}));!0===c.p.pginput&&a("input.ui-pg-input","#"+h).keypress(function(b){if(13===(b.charCode||b.keyCode||0)){if(!n("user"))return!1;a(this).val(r(a(this).val(),1));c.p.page=0<a(this).val()?a(this).val():c.p.page;D();return!1}return this})},Y=function(b,d){var e,f="",g=c.p.colModel,k=!1,h;h=c.p.frozenColumns?d:c.grid.headers[b].el;var l="";a("span.ui-grid-ico-sort",h).addClass("ui-state-disabled");a(h).attr("aria-selected","false");if(g[b].lso)if("asc"===g[b].lso)g[b].lso+="-desc",l="desc";
            ...
            f=f.substring(0,h);c.p.sortname=f},F=function(b,d,e,f,g){if(c.p.colModel[d].sortable&&!(0<c.p.savedRow.length)){e||(c.p.lastsort===d?"asc"===c.p.sortorder?c.p.sortorder="desc":"desc"===c.p.sortorder&&(c.p.sortorder="asc"):c.p.sortorder=c.p.colModel[d].firstsortorder||"asc",c.p.page=1);if(c.p.multiSort)Y(d,g);else{if(f){if(c.p.lastsort===d&&c.p.sortorder===f&&!e)return;c.p.sortorder=f}e=c.grid.headers[c.p.lastsort].el;g=c.p.frozenColumns?g:c.grid.headers[d].el;a("span.ui-grid-ico-sort",e).addClass("ui-state-disabled");
            a(e).attr("aria-selected","false");c.p.frozenColumns&&(c.grid.fhDiv.find("span.ui-grid-ico-sort").addClass("ui-state-disabled"),c.grid.fhDiv.find("th").attr("aria-selected","false"));a("span.ui-icon-"+c.p.sortorder,g).removeClass("ui-state-disabled");a(g).attr("aria-selected","true");c.p.viewsortcols[0]||c.p.lastsort===d||(c.p.frozenColumns&&c.grid.fhDiv.find("span.s-ico").hide(),a("span.s-ico",e).hide(),a("span.s-ico",g).show());b=b.substring(5+c.p.id.length+1);c.p.sortname=c.p.colModel[d].index||
                b}"stop"===a(c).triggerHandler("jqGridSortCol",[c.p.sortname,d,c.p.sortorder])?c.p.lastsort=d:a.isFunction(c.p.onSortCol)&&"stop"===c.p.onSortCol.call(c,c.p.sortname,d,c.p.sortorder)?c.p.lastsort=d:("local"===c.p.datatype?c.p.deselectAfterSort&&a(c).jqGrid("resetSelection"):(c.p.selrow=null,c.p.multiselect&&Q(!1),c.p.selarrrow=[],c.p.savedRow=[]),c.p.scroll&&(g=c.grid.bDiv.scrollLeft,A.call(c,!0,!1),c.grid.hDiv.scrollLeft=g),c.p.subGrid&&"local"===c.p.datatype&&a("td.sgexpanded","#"+a.jgrid.jqID(c.p.id)).each(function(){a(this).trigger("click")}),
            D(),c.p.lastsort=d,c.p.sortname!==b&&d&&(c.p.lastsort=d))}},ca=function(b){b=a(c.grid.headers[b].el);b=[b.position().left+b.outerWidth()];"rtl"===c.p.direction&&(b[0]=c.p.width-b[0]);b[0]-=c.grid.bDiv.scrollLeft;b.push(a(c.grid.hDiv).position().top);b.push(a(c.grid.bDiv).offset().top-a(c.grid.hDiv).offset().top+a(c.grid.bDiv).height());return b},T=function(b){var d,e=c.grid.headers,f=a.jgrid.getCellIndex(b);for(d=0;d<e.length;d++)if(b===e[d].el){f=d;break}return f};this.p.id=this.id;-1===a.inArray(c.p.multikey,
        ["shiftKey","altKey","ctrlKey"])&&(c.p.multikey=!1);c.p.keyIndex=!1;c.p.keyName=!1;for(g=0;g<c.p.colModel.length;g++)c.p.colModel[g]=a.extend(!0,{},c.p.cmTemplate,c.p.colModel[g].template||{},c.p.colModel[g]),!1===c.p.keyIndex&&!0===c.p.colModel[g].key&&(c.p.keyIndex=g);c.p.sortorder=c.p.sortorder.toLowerCase();a.jgrid.cell_width=a.jgrid.cellWidth();!0===c.p.grouping&&(c.p.scroll=!1,c.p.rownumbers=!1,c.p.treeGrid=!1,c.p.gridview=!0);if(!0===this.p.treeGrid){try{a(this).jqGrid("setTreeGrid")}catch(Z){}"local"!==
    c.p.datatype&&(c.p.localReader={id:"_id_"})}if(this.p.subGrid)try{a(c).jqGrid("setSubGrid")}catch(ia){}this.p.multiselect&&(this.p.colNames.unshift("<input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/>"),this.p.colModel.unshift({name:"cb",width:a.jgrid.cell_width?c.p.multiselectWidth+c.p.cellLayout:c.p.multiselectWidth,sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0}));this.p.rownumbers&&(this.p.colNames.unshift(""),this.p.colModel.unshift({name:"rn",width:c.p.rownumWidth,
        ...
        c.p.jsonReader);c.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},c.p.localReader);c.p.scroll&&(c.p.pgbuttons=!1,c.p.pginput=!1,c.p.rowList=[]);c.p.data.length&&B();var I="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",L,K,O,aa,U,G,N,S,ga=S="",R=[],la=[];K=[];if(!0===c.p.shrinkToFit&&!0===c.p.forceFit)for(g=c.p.colModel.length-1;0<=g;g--)if(!c.p.colModel[g].hidden){c.p.colModel[g].resizable=
        !1;break}"horizontal"===c.p.viewsortcols[1]&&(S=" ui-i-asc",ga=" ui-i-desc");L=m?"class='ui-th-div-ie'":"";S="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+S+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+k+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ga+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+k+"'></span></span>");if(c.p.multiSort)for(R=c.p.sortname.split(","),g=0;g<R.length;g++)K=a.trim(R[g]).split(" "),
        R[g]=a.trim(K[0]),la[g]=K[1]?a.trim(K[1]):c.p.sortorder||"asc";for(g=0;g<this.p.colNames.length;g++)K=c.p.headertitles?' title="'+a.jgrid.stripHtml(c.p.colNames[g])+'"':"",I+="<th id='"+c.p.id+"_"+c.p.colModel[g].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+k+"'"+K+">",K=c.p.colModel[g].index||c.p.colModel[g].name,I+="<div id='jqgh_"+c.p.id+"_"+c.p.colModel[g].name+"' "+L+">"+c.p.colNames[g],c.p.colModel[g].width=c.p.colModel[g].width?parseInt(c.p.colModel[g].width,10):
        150,"boolean"!==typeof c.p.colModel[g].title&&(c.p.colModel[g].title=!0),c.p.colModel[g].lso="",K===c.p.sortname&&(c.p.lastsort=g),c.p.multiSort&&(K=a.inArray(K,R),-1!==K&&(c.p.colModel[g].lso=la[K])),I+=S+"</div></th>";I+="</tr></thead>";S=null;a(this).append(I);a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var V=[],ea;a("#cb_"+a.jgrid.jqID(c.p.id),this).bind("click",function(){c.p.selarrrow=
        ...
        "prop":"attr"]("checked",!0),a("#"+a.jgrid.jqID(this.id),c.grid.fbDiv).addClass("ui-state-highlight")))}),ea=!0,V=[]):(a(c.rows).each(function(d){0<d&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("ui-state-disabled")&&(a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id))[c.p.useProp?"prop":"attr"]("checked",!1),a(this).removeClass("ui-state-highlight").attr("aria-selected","false"),V.push(this.id),b&&(a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id),c.grid.fbDiv)[c.p.useProp?"prop":
        "attr"]("checked",!1),a("#"+a.jgrid.jqID(this.id),c.grid.fbDiv).removeClass("ui-state-highlight")))}),c.p.selrow=null,ea=!1);a(c).triggerHandler("jqGridSelectAll",[ea?c.p.selarrrow:V,ea]);a.isFunction(c.p.onSelectAll)&&c.p.onSelectAll.call(c,ea?c.p.selarrrow:V,ea)})}!0===c.p.autowidth&&(I=a(p).innerWidth(),c.p.width=0<I?I:"nw");(function(){var b=0,d=a.jgrid.cell_width?0:r(c.p.cellLayout,0),f=0,g,k=r(c.p.scrollOffset,0),l,m=!1,p,n=0,q;a.each(c.p.colModel,function(){void 0===this.hidden&&(this.hidden=
    ...
    (p-=k,m=!0),b=0,a.each(c.p.colModel,function(a){!1!==this.hidden||this.fixed||(this.width=l=Math.round(p*this.width/(c.p.tblwidth-d*f-n)),b+=l,g=a)}),q=0,m?e.width-n-(b+d*f)!==k&&(q=e.width-n-(b+d*f)-k):m||1===Math.abs(e.width-n-(b+d*f))||(q=e.width-n-(b+d*f)),c.p.colModel[g].width+=q,c.p.tblwidth=b+q+d*f+n,c.p.tblwidth>c.p.width&&(c.p.colModel[g].width-=c.p.tblwidth-parseInt(c.p.width,10),c.p.tblwidth=c.p.width))})();a(p).css("width",e.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+
        c.p.id+"'>&#160;</div>");a(l).css("width",e.width+"px");var I=a("thead:first",c).get(0),da="";c.p.footerrow&&(da+="<table role='grid' style='width:"+c.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+k+"'>");var l=a("tr:first",I),fa="<tr class='jqgfirstrow' role='row' style='height:auto'>";c.p.disableClick=!1;a("th",l).each(function(b){O=c.p.colModel[b].width;void 0===c.p.colModel[b].resizable&&(c.p.colModel[b].resizable=
        !0);c.p.colModel[b].resizable?(aa=document.createElement("span"),a(aa).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+k).css("cursor","col-resize"),a(this).addClass(c.p.resizeclass)):aa="";a(this).css("width",O+"px").prepend(aa);aa=null;var d="";c.p.colModel[b].hidden&&(a(this).css("display","none"),d="display:none;");fa+="<td role='gridcell' style='height:0px;width:"+O+"px;"+d+"'></td>";e.headers[b]={width:O,el:this};U=c.p.colModel[b].sortable;"boolean"!==typeof U&&(U=c.p.colModel[b].sortable=
        !0);d=c.p.colModel[b].name;"cb"!==d&&"subgrid"!==d&&"rn"!==d&&c.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");U&&(c.p.multiSort?c.p.viewsortcols[0]?(a("div span.s-ico",this).show(),c.p.colModel[b].lso&&a("div span.ui-icon-"+c.p.colModel[b].lso,this).removeClass("ui-state-disabled")):c.p.colModel[b].lso&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+c.p.colModel[b].lso,this).removeClass("ui-state-disabled")):c.p.viewsortcols[0]?(a("div span.s-ico",this).show(),b===c.p.lastsort&&
    a("div span.ui-icon-"+c.p.sortorder,this).removeClass("ui-state-disabled")):b===c.p.lastsort&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+c.p.sortorder,this).removeClass("ui-state-disabled")));c.p.footerrow&&(da+="<td role='gridcell' "+q(b,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(b){if(1===a(b.target).closest("th>span.ui-jqgrid-resize").length){var d=T(this);if(!0===c.p.forceFit){var f=c.p,g=d,k;for(k=d+1;k<c.p.colModel.length;k++)if(!0!==c.p.colModel[k].hidden){g=k;break}f.nv=
        g-d}e.dragStart(d,b,ca(d));return!1}}).click(function(b){if(c.p.disableClick)return c.p.disableClick=!1;var d="th>div.ui-jqgrid-sortable",e,f;c.p.viewsortcols[2]||(d="th>div>span>span.ui-grid-ico-sort");b=a(b.target).closest(d);if(1===b.length){var g;if(c.p.frozenColumns){var k=a(this)[0].id.substring(c.p.id.length+1);a(c.p.colModel).each(function(a){if(this.name===k)return g=a,!1})}else g=T(this);c.p.viewsortcols[2]||(e=!0,f=b.attr("sort"));null!=g&&F(a("div",this)[0].id,g,e,f,this);return!1}});
    if(c.p.sortable&&a.fn.sortable)try{a(c).jqGrid("sortableColumns",l)}catch(na){}c.p.footerrow&&(da+="</tr></tbody></table>");fa+="</tr>";l=document.createElement("tbody");this.appendChild(l);a(this).addClass("ui-jqgrid-btable").append(fa);var fa=null,l=a("<table class='ui-jqgrid-htable' style='width:"+c.p.tblwidth+"px' role='grid' aria-labelledby='gbox_"+this.id+"' cellspacing='0' cellpadding='0' border='0'></table>").append(I),X=c.p.caption&&!0===c.p.hiddengrid?!0:!1;g=a("<div class='ui-jqgrid-hbox"+
    ...
    c.p.cellEdit&&!0===c.p.hoverrows&&a(c).bind("mouseover",function(c){N=a(c.target).closest("tr.jqgrow");"ui-subgrid"!==a(N).attr("class")&&a(N).addClass("ui-state-hover")}).bind("mouseout",function(c){N=a(c.target).closest("tr.jqgrow");a(N).removeClass("ui-state-hover")});var P,ba,ja;a(c).before(e.hDiv).click(function(b){G=b.target;N=a(G,c.rows).closest("tr.jqgrow");if(0===a(N).length||-1<N[0].className.indexOf("ui-state-disabled")||(a(G,c).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen",
            "")!==c.id)return this;var d=a(G).hasClass("cbox"),e=a(c).triggerHandler("jqGridBeforeSelectRow",[N[0].id,b]);(e=!1===e||"stop"===e?!1:!0)&&a.isFunction(c.p.beforeSelectRow)&&(e=c.p.beforeSelectRow.call(c,N[0].id,b));if("A"!==G.tagName&&("INPUT"!==G.tagName&&"TEXTAREA"!==G.tagName&&"OPTION"!==G.tagName&&"SELECT"!==G.tagName||d)&&!0===e)if(P=N[0].id,ba=a.jgrid.getCellIndex(G),ja=a(G).closest("td,th").html(),a(c).triggerHandler("jqGridCellSelect",[P,ba,ja,b]),a.isFunction(c.p.onCellSelect)&&c.p.onCellSelect.call(c,
            P,ba,ja,b),!0===c.p.cellEdit)if(c.p.multiselect&&d)a(c).jqGrid("setSelection",P,!0,b);else{P=N[0].rowIndex;try{a(c).jqGrid("editCell",P,ba,!0)}catch(f){}}else if(c.p.multikey)b[c.p.multikey]?a(c).jqGrid("setSelection",P,!0,b):c.p.multiselect&&d&&(d=a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+P).is(":checked"),a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+P)[c.p.useProp?"prop":"attr"]("checked",d));else{if(c.p.multiselect&&c.p.multiboxonly&&!d){var g=c.p.frozenColumns?c.p.id+"_frozen":"";a(c.p.selarrrow).each(function(b,
        ...
        d&&d.current&&c.grid.selectionPreserver(c);"local"===c.p.datatype?(a(c).jqGrid("resetSelection"),c.p.data.length&&B()):c.p.treeGrid||(c.p.selrow=null,c.p.multiselect&&(c.p.selarrrow=[],Q(!1)),c.p.savedRow=[]);c.p.scroll&&A.call(c,!0,!1);if(d&&d.page){var e=d.page;e>c.p.lastpage&&(e=c.p.lastpage);1>e&&(e=1);c.p.page=e;c.grid.bDiv.scrollTop=c.grid.prevRowHeight?(e-1)*c.grid.prevRowHeight*c.p.rowNum:0}c.grid.prevRowHeight&&c.p.scroll?(delete c.p.lastpage,c.grid.populateVisible()):c.grid.populate();!0===
        c.p._inlinenav&&a(c).jqGrid("showAddEditButtons");return!1}).dblclick(function(b){G=b.target;N=a(G,c.rows).closest("tr.jqgrow");0!==a(N).length&&(P=N[0].rowIndex,ba=a.jgrid.getCellIndex(G),a(c).triggerHandler("jqGridDblClickRow",[a(N).attr("id"),P,ba,b]),a.isFunction(c.p.ondblClickRow)&&c.p.ondblClickRow.call(c,a(N).attr("id"),P,ba,b))}).bind("contextmenu",function(b){G=b.target;N=a(G,c.rows).closest("tr.jqgrow");0!==a(N).length&&(c.p.multiselect||a(c).jqGrid("setSelection",N[0].id,!0,b),P=N[0].rowIndex,
        ba=a.jgrid.getCellIndex(G),a(c).triggerHandler("jqGridRightClickRow",[a(N).attr("id"),P,ba,b]),a.isFunction(c.p.onRightClickRow)&&c.p.onRightClickRow.call(c,a(N).attr("id"),P,ba,b))});e.bDiv=document.createElement("div");m&&"auto"===String(c.p.height).toLowerCase()&&(c.p.height="100%");a(e.bDiv).append(a('<div style="position:relative;'+(m&&8>a.jgrid.msiever()?"height:0.01%;":"")+'"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:c.p.height+(isNaN(c.p.height)?"":
        "px"),width:e.width+"px"}).scroll(e.scrollGrid);a("table:first",e.bDiv).css({width:c.p.tblwidth+"px"});a.support.tbody||2===a("tbody",this).length&&a("tbody:gt(0)",this).remove();c.p.multikey&&(a.jgrid.msie?a(e.bDiv).bind("selectstart",function(){return!1}):a(e.bDiv).bind("mousedown",function(){return!1}));X&&a(e.bDiv).hide();e.cDiv=document.createElement("div");var ka=!0===c.p.hidegrid?a("<a role='link' class='ui-jqgrid-titlebar-close ui-corner-all HeaderButton' />").hover(function(){ka.addClass("ui-state-hover")},
        function(){ka.removeClass("ui-state-hover")}).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css("rtl"===k?"left":"right","0px"):"";a(e.cDiv).append(ka).append("<span class='ui-jqgrid-title'>"+c.p.caption+"</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===k?"-rtl":"")+" ui-widget-header ui-corner-top ui-helper-clearfix");a(e.cDiv).insertBefore(e.hDiv);c.p.toolbar[0]&&(e.uDiv=document.createElement("div"),"top"===c.p.toolbar[1]?a(e.uDiv).insertBefore(e.hDiv):"bottom"===
    c.p.toolbar[1]&&a(e.uDiv).insertAfter(e.hDiv),"both"===c.p.toolbar[1]?(e.ubDiv=document.createElement("div"),a(e.uDiv).addClass("ui-userdata ui-state-default").attr("id","t_"+this.id).insertBefore(e.hDiv),a(e.ubDiv).addClass("ui-userdata ui-state-default").attr("id","tb_"+this.id).insertAfter(e.hDiv),X&&a(e.ubDiv).hide()):a(e.uDiv).width(e.width).addClass("ui-userdata ui-state-default").attr("id","t_"+this.id),X&&a(e.uDiv).hide());c.p.toppager&&(c.p.toppager=a.jgrid.jqID(c.p.id)+"_toppager",e.topDiv=
        a("<div id='"+c.p.toppager+"'></div>")[0],c.p.toppager="#"+c.p.toppager,a(e.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(e.width).insertBefore(e.hDiv),W(c.p.toppager,"_t"));c.p.footerrow&&(e.sDiv=a("<div class='ui-jqgrid-sdiv'></div>")[0],g=a("<div class='ui-jqgrid-hbox"+("rtl"===k?"-rtl":"")+"'></div>"),a(e.sDiv).append(g).width(e.width).insertAfter(e.hDiv),a(g).append(da),e.footers=a(".ui-jqgrid-ftable",e.sDiv)[0].rows[0].cells,c.p.rownumbers&&(e.footers[0].className="ui-state-default jqgrid-rownum"),
    X&&a(e.sDiv).hide());g=null;if(c.p.caption){var ma=c.p.datatype;!0===c.p.hidegrid&&(a(".ui-jqgrid-titlebar-close",e.cDiv).click(function(b){var d=a.isFunction(c.p.onHeaderClick),f=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv",g,k=this;!0===c.p.toolbar[0]&&("both"===c.p.toolbar[1]&&(f+=", #"+a(e.ubDiv).attr("id")),f+=", #"+a(e.uDiv).attr("id"));g=a(f,"#gview_"+a.jgrid.jqID(c.p.id)).length;"visible"===c.p.gridstate?a(f,"#gbox_"+a.jgrid.jqID(c.p.id)).slideUp("fast",function(){g--;
...
delete p[g.p.treeReader[n]];void 0!==q&&(g.p.data[q]=a.extend(!0,g.p.data[q],p));p=null}}catch(t){c=!1}c&&("string"===m?a(l).addClass(b):null!==b&&"object"===m&&a(l).css(b),a(g).triggerHandler("jqGridAfterGridComplete"))});return c},addRowData:function(d,e,b,f){b||(b="last");var c=!1,h,g,k,l,m,p,r,q,n="",t,v,w,u,x,y;e&&(a.isArray(e)?(t=!0,b="last",v=d):(e=[e],t=!1),this.each(function(){var A=e.length;m=!0===this.p.rownumbers?1:0;k=!0===this.p.multiselect?1:0;l=!0===this.p.subGrid?
    1:0;t||(void 0!==d?d=String(d):(d=a.jgrid.randId(),!1!==this.p.keyIndex&&(v=this.p.colModel[this.p.keyIndex+k+l+m].name,void 0!==e[0][v]&&(d=e[0][v]))));w=this.p.altclass;for(var B=0,J="",C={},M=a.isFunction(this.p.afterInsertRow)?!0:!1;B<A;){u=e[B];g=[];if(t){try{d=u[v],void 0===d&&(d=a.jgrid.randId())}catch(H){d=a.jgrid.randId()}J=!0===this.p.altRows?0===(this.rows.length-1)%2?w:"":""}y=d;d=this.p.idPrefix+d;m&&(n=this.formatCol(0,1,"",null,d,!0),g[g.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+
    n+">0</td>");k&&(q='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+d+'" class="cbox"/>',n=this.formatCol(m,1,"",null,d,!0),g[g.length]='<td role="gridcell" '+n+">"+q+"</td>");l&&(g[g.length]=a(this).jqGrid("addSubGridCell",k+m,1));for(r=k+l+m;r<this.p.colModel.length;r++)x=this.p.colModel[r],h=x.name,C[h]=u[h],q=this.formatter(d,a.jgrid.getAccessor(u,h),r,u),n=this.formatCol(r,1,q,u,d,C),g[g.length]='<td role="gridcell" '+n+">"+q+"</td>";g.unshift(this.constructTr(d,!1,J,C,u,!1));
...
!0===this.p.toolbar[0]&&("both"===this.p.toolbar[1]&&a(this.grid.ubDiv).slideDown("fast"),a(this.grid.uDiv).slideDown("fast")),this.p.footerrow&&a(".ui-jqgrid-sdiv","#gbox_"+a.jgrid.jqID(this.p.id)).slideDown("fast"),a(".ui-jqgrid-titlebar-close span",this.grid.cDiv).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n"),this.p.gridstate="visible"))})},filterToolbar:function(d){d=a.extend({autosearch:!0,searchOnEnter:!0,beforeSearch:null,afterSearch:null,beforeClear:null,afterClear:null,
    ...
    var q=0<c?!0:!1;if(!0===d.stringResult||"local"===e.p.datatype){var n='{"groupOp":"'+d.groupOp+'","rules":[',t=0;a.each(b,function(a,b){0<t&&(n+=",");n+='{"field":"'+a+'",';n+='"op":"'+p[a]+'",';n+='"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}';t++});n+="]}";a.extend(e.p.postData,{filters:n});a.each(["searchField","searchString","searchOper"],function(a,b){e.p.postData.hasOwnProperty(b)&&delete e.p.postData[b]})}else a.extend(e.p.postData,b);var v;e.p.searchurl&&(v=e.p.url,a(e).jqGrid("setGridParam",
        {url:e.p.searchurl}));var w="stop"===a(e).triggerHandler("jqGridToolbarBeforeSearch")?!0:!1;!w&&a.isFunction(d.beforeSearch)&&(w=d.beforeSearch.call(e));w||a(e).jqGrid("setGridParam",{search:q}).trigger("reloadGrid",[{page:1}]);v&&a(e).jqGrid("setGridParam",{url:v});a(e).triggerHandler("jqGridToolbarAfterSearch");a.isFunction(d.afterSearch)&&d.afterSearch.call(e)},f=function(c,f,h){a("#sopt_menu").remove();f=parseInt(f,10);h=parseInt(h,10)+18;f='<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:'+
    ...
    e.p.direction+"'></th>"),n=a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"),t=a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear'></td></tr></table>");!0===this.hidden&&a(q).css("display","none");this.search=!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");l=a.extend({},this.searchoptions||{});if(this.search){if(d.searchOperators){m=l.sopt?l.sopt[0]:
    "select"===k.stype?"eq":d.defaultSearch;for(r=0;r<d.odata.length;r++)if(d.odata[r].oper===m){p=d.operands[m]||"";break}m="<a title='"+(null!=l.searchtitle?l.searchtitle:d.operandTitle)+"' style='padding-right: 0.5em;' soper='"+m+"' class='soptclass' colname='"+this.name+"'>"+p+"</a>"}a("td:eq(0)",t).attr("colindex",f).append(m);void 0===l.clearSearch&&(l.clearSearch=!0);l.clearSearch?(m=d.resetTitle||"Clear Search Value",a("td:eq(2)",t).append("<a title='"+m+"' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>"+
    d.resetIcon+"</a>")):a("td:eq(2)",t).hide();switch(this.stype){case "select":if(m=this.surl||l.dataUrl)a(n).append(t),a.ajax(a.extend({url:m,dataType:"html",success:function(c){void 0!==l.buildSelect?(c=l.buildSelect(c))&&a("td:eq(1)",t).append(c):a("td:eq(1)",t).append(c);void 0!==l.defaultValue&&a("select",n).val(l.defaultValue);a("select",n).attr({name:k.index||k.name,id:"gs_"+k.name});l.attr&&a("select",n).attr(l.attr);a("select",n).css({width:"100%"});a.jgrid.bindEv.call(e,a("select",n)[0],l);
    !0===d.autosearch&&a("select",n).change(function(){b();return!1});c=null}},a.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{}));else{var v,w,u;k.searchoptions?(v=void 0===k.searchoptions.value?"":k.searchoptions.value,w=void 0===k.searchoptions.separator?":":k.searchoptions.separator,u=void 0===k.searchoptions.delimiter?";":k.searchoptions.delimiter):k.editoptions&&(v=void 0===k.editoptions.value?"":k.editoptions.value,w=void 0===k.editoptions.separator?":":k.editoptions.separator,u=void 0===k.editoptions.delimiter?
    ";":k.editoptions.delimiter);if(v){var x=document.createElement("select");x.style.width="100%";a(x).attr({name:k.index||k.name,id:"gs_"+k.name});var y;if("string"===typeof v)for(m=v.split(u),y=0;y<m.length;y++)v=m[y].split(w),u=document.createElement("option"),u.value=v[0],u.innerHTML=v[1],x.appendChild(u);else if("object"===typeof v)for(y in v)v.hasOwnProperty(y)&&(u=document.createElement("option"),u.value=y,u.innerHTML=v[y],x.appendChild(u));void 0!==l.defaultValue&&a(x).val(l.defaultValue);l.attr&&
a(x).attr(l.attr);a(n).append(t);a.jgrid.bindEv.call(e,x,l);a("td:eq(1)",t).append(x);!0===d.autosearch&&a(x).change(function(){b();return!1})}}break;case "text":w=void 0!==l.defaultValue?l.defaultValue:"";a("td:eq(1)",t).append("<input type='text' style='width:100%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+k.name+"' value='"+w+"'/>");a(n).append(t);l.attr&&a("input",n).attr(l.attr);a.jgrid.bindEv.call(e,a("input",n)[0],l);!0===d.autosearch&&(d.searchOnEnter?a("input",n).keypress(function(a){return 13===
(a.charCode||a.keyCode||0)?(b(),!1):this}):a("input",n).keydown(function(a){switch(a.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:h&&clearTimeout(h),h=setTimeout(function(){b()},500)}}));break;case "custom":a("td:eq(1)",t).append("<span style='width:95%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+k.name+"'/>");a(n).append(t);try{if(a.isFunction(l.custom_element))if(x=l.custom_element.call(e,void 0!==l.defaultValue?l.defaultValue:"",l))x=a(x).addClass("customelement"),
    a(n).find(">span").append(x);else throw"e2";else throw"e1";}catch(A){"e1"===A&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===A?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof A?A:A.message,a.jgrid.edit.bClose)}}}a(q).append(n);a(c).append(q);d.searchOperators||a("td:eq(0)",t).hide()});a("table thead",
...
c&&(this.selected=!0);if(a(this).val()===b)return this.selected=!0,!1});if(void 0!==b)c[h]=b,f++;else try{delete e.p.postData[h]}catch(g){}break;case "text":d.val(b||"");if(void 0!==b)c[h]=b,f++;else try{delete e.p.postData[h]}catch(n){}break;case "custom":a.isFunction(this.searchoptions.custom_value)&&0<d.length&&"SPAN"===d[0].nodeName.toUpperCase()&&this.searchoptions.custom_value.call(e,d.children(".customelement:first"),"set",b||"")}});var p=0<f?!0:!1;e.p.resetsearch=!0;if(!0===d.stringResult||
    "local"===e.p.datatype){var r='{"groupOp":"'+d.groupOp+'","rules":[',q=0;a.each(c,function(a,b){0<q&&(r+=",");r+='{"field":"'+a+'",';r+='"op":"eq",';r+='"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}';q++});r+="]}";a.extend(e.p.postData,{filters:r});a.each(["searchField","searchString","searchOper"],function(a,b){e.p.postData.hasOwnProperty(b)&&delete e.p.postData[b]})}else a.extend(e.p.postData,c);var n;e.p.searchurl&&(n=e.p.url,a(e).jqGrid("setGridParam",{url:e.p.searchurl}));var t=
    "stop"===a(e).triggerHandler("jqGridToolbarBeforeClear")?!0:!1;!t&&a.isFunction(d.beforeClear)&&(t=d.beforeClear.call(e));t||b&&a(e).jqGrid("setGridParam",{search:p}).trigger("reloadGrid",[{page:1}]);n&&a(e).jqGrid("setGridParam",{url:n});a(e).triggerHandler("jqGridToolbarAfterClear");a.isFunction(d.afterClear)&&d.afterClear()};this.toggleToolbar=function(){var b=a("tr.ui-search-toolbar",e.grid.hDiv),c=!0===e.p.frozenColumns?a("tr.ui-search-toolbar",e.grid.fhDiv):!1;"none"===b.css("display")?(b.show(),
c&&c.show()):(b.hide(),c&&c.hide())}}})},destroyFilterToolbar:function(){return this.each(function(){this.ftoolbar&&(this.toggleToolbar=this.clearToolbar=this.triggerToolbar=null,this.ftoolbar=!1,a(this.grid.hDiv).find("table thead tr.ui-search-toolbar").remove())})},destroyGroupHeader:function(d){void 0===d&&(d=!0);return this.each(function(){var e,b,f,c,h,g;b=this.grid;var k=a("table.ui-jqgrid-htable thead",b.hDiv),l=this.p.colModel;if(b){a(this).unbind(".setGroupHeaders");e=a("<tr>",{role:"rowheader"}).addClass("ui-jqgrid-labels");
    ...
    c=a("<tr>",{role:"rowheader"}).addClass("ui-jqgrid-labels jqg-third-row-header");for(e=0;e<p;e++)if(g=r[e].el,k=a(g),b=m[e],h={height:"0px",width:r[e].width+"px",display:b.hidden?"none":""},a("<th>",{role:"gridcell"}).css(h).addClass("ui-first-th-"+this.p.direction).appendTo(t),g.style.width="",h=w(b.name,d.groupHeaders),0<=h){h=d.groupHeaders[h];f=h.numberOfColumns;l=h.titleText;for(h=b=0;h<f&&e+h<p;h++)m[e+h].hidden||b++;h=a("<th>").attr({role:"columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-"+
        this.p.direction).css({height:"22px","border-top":"0 none"}).html(l);0<b&&h.attr("colspan",String(b));this.p.headertitles&&h.attr("title",h.text());0===b&&h.hide();k.before(h);c.append(g);--f}else 0===f?d.useColSpanStyle?k.attr("rowspan","2"):(a("<th>",{role:"columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-"+this.p.direction).css({display:b.hidden?"none":"","border-top":"0 none"}).insertBefore(k),c.append(g)):(c.append(g),f--);m=a(this).children("thead");m.prepend(t);c.insertAfter(n);
...
(function(a){a.fn.jqm=function(b){var c={overlay:50,closeoverlay:!0,overlayClass:"jqmOverlay",closeClass:"jqmClose",trigger:".jqModal",ajax:f,ajaxText:"",target:f,modal:f,toTop:f,onShow:f,onHide:f,onLoad:f};return this.each(function(){if(this._jqm)return e[this._jqm].c=a.extend({},e[this._jqm].c,b);d++;this._jqm=d;e[d]={c:a.extend(c,a.jqm.params,b),a:f,w:a(this).addClass("jqmID"+d),s:d};c.trigger&&a(this).jqmAddTrigger(c.trigger)})};a.fn.jqmAddClose=function(a){return k(this,a,"jqmHide")};a.fn.jqmAddTrigger=
    function(a){return k(this,a,"jqmShow")};a.fn.jqmShow=function(b){return this.each(function(){a.jqm.open(this._jqm,b)})};a.fn.jqmHide=function(b){return this.each(function(){a.jqm.close(this._jqm,b)})};a.jqm={hash:{},open:function(d,g){var k=e[d],r=k.c,q="."+r.closeClass,n=parseInt(k.w.css("z-index")),n=0<n?n:3E3,t=a("<div></div>").css({height:"100%",width:"100%",position:"fixed",left:0,top:0,"z-index":n-1,opacity:r.overlay/100});if(k.a)return f;k.t=g;k.a=!0;k.w.css("z-index",n);r.modal?(b[0]||setTimeout(function(){h("bind")},
    1),b.push(d)):0<r.overlay?r.closeoverlay&&k.w.jqmAddClose(t):t=f;k.o=t?t.addClass(r.overlayClass).prependTo("body"):f;r.ajax?(n=r.target||k.w,t=r.ajax,n="string"==typeof n?a(n,k.w):a(n),t="@"==t.substr(0,1)?a(g).attr(t.substring(1)):t,n.html(r.ajaxText).load(t,function(){r.onLoad&&r.onLoad.call(this,k);q&&k.w.jqmAddClose(a(q,k.w));c(k)})):q&&k.w.jqmAddClose(a(q,k.w));r.toTop&&k.o&&k.w.before('<span id="jqmP'+k.w[0]._jqm+'"></span>').insertAfter(k.o);r.onShow?r.onShow(k):k.w.show();c(k);return f},
...
void 0!==e.colModel.formatoptions&&(b=a.extend({},b,e.colModel.formatoptions));return b.reformatAfterEdit||"edit"!==f?a.fmatter.isEmpty(d)?a.fn.fmatter.defaultFormat(d,e):a.jgrid.parseDate(b.srcformat,d,b.newformat,b):a.fn.fmatter.defaultFormat(d,e)};a.fn.fmatter.select=function(d,e){d=String(d);var b=!1,f=[],c,h;void 0!==e.colModel.formatoptions?(b=e.colModel.formatoptions.value,c=void 0===e.colModel.formatoptions.separator?":":e.colModel.formatoptions.separator,h=void 0===e.colModel.formatoptions.delimiter?
    ...
    "><span class='ui-icon ui-icon-disk'></span></div>";c+="<div title='"+a.jgrid.edit.bCancel+"' style='float:left;display:none;margin-left:5px;' class='ui-pg-div ui-inline-cancel' "+("id='jCancelButton_"+f+"' onclick=jQuery.fn.fmatter.rowactions.call(this,'cancel'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ")+"><span class='ui-icon ui-icon-cancel'></span></div>";return"<div style='margin-left:8px;'>"+c+"</div>"};a.unformat=function(d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         e,b,f){var c,h=e.colModel.formatter,g=e.colModel.formatoptions||{},k=/([\.\*\_\'\(\)\{\}\+\?\\])/g,l=e.colModel.unformat||a.fn.fmatter[h]&&a.fn.fmatter[h].unformat;if(void 0!==l&&a.isFunction(l))c=l.call(this,a(d).text(),e,d);else if(void 0!==h&&a.fmatter.isString(h))switch(c=a.jgrid.formatter||{},h){case "integer":g=a.extend({},c.integer,g);e=g.thousandsSeparator.replace(k,"\\$1");e=new RegExp(e,"g");c=a(d).text().replace(e,"");break;case "number":g=a.extend({},c.number,g);e=g.thousandsSeparator.replace(k,
    "\\$1");e=new RegExp(e,"g");c=a(d).text().replace(e,"").replace(g.decimalSeparator,".");break;case "currency":g=a.extend({},c.currency,g);e=g.thousandsSeparator.replace(k,"\\$1");e=new RegExp(e,"g");c=a(d).text();g.prefix&&g.prefix.length&&(c=c.substr(g.prefix.length));g.suffix&&g.suffix.length&&(c=c.substr(0,c.length-g.suffix.length));c=c.replace(e,"").replace(g.decimalSeparator,".");break;case "checkbox":g=e.colModel.editoptions?e.colModel.editoptions.value.split(":"):["Yes","No"];c=a("input",d).is(":checked")?
...
b+"</a>"+d+"</div>":""!==d?"<div class='ui-widget-content ui-helper-clearfix' style='text-align:"+c.buttonalign+";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'>"+d+"</div>":"";e+="</div>";try{"false"===a("#info_dialog").attr("aria-hidden")&&a.jgrid.hideModal("#info_dialog",{jqm:h}),a("#info_dialog").remove()}catch(k){}a.jgrid.createModal({themodal:"info_dialog",modalhead:"info_head",modalcontent:"info_content",scrollelm:"infocnt"},e,c,"","",!0);d&&a.each(c.buttons,
    ...
    l=b[a[g]].toString();if(1>l.length||1>b[a[g]]||12<b[a[g]]||-1===f)return!1;l=b[a[f]].toString();!(h=1>l.length||1>b[a[f]]||31<b[a[f]])&&(h=2===b[a[g]])&&(c=b[a[c]],h=b[a[f]]>(0!==c%4||0===c%100&&0!==c%400?28:29));return h||b[a[f]]>k[b[a[g]]]?!1:!0},isEmpty:function(a){return a.match(/^\s+$/)||""===a?!0:!1},checkTime:function(d){var e=/^(\d{1,2}):(\d{2})([apAP][Mm])?$/;if(!a.jgrid.isEmpty(d))if(d=d.match(e)){if(d[3]){if(1>d[1]||12<d[1])return!1}else if(23<d[1])return!1;if(59<d[2])return!1}else return!1;
...
(function(a){a.fn.jqFilter=function(d){if("string"===typeof d){var e=a.fn.jqFilter[d];if(!e)throw"jqFilter - No such method: "+d;var b=a.makeArray(arguments).slice(1);return e.apply(this,b)}var f=a.extend(!0,{filter:null,columns:[],onChange:null,afterRedraw:null,checkValues:null,error:!1,errmsg:"",errorcheck:!0,showQuery:!0,sopt:null,ops:[],operands:null,numopts:"eq ne lt le gt ge nu nn in ni".split(" "),stropts:"eq ne bw bn ew en cn nc nu nn in ni".split(" "),strarr:["text","string","blob"],groupOps:[{op:"AND",
    ...
    c||c&&!f){x=d.p.columns[e];break}}c=x.searchoptions.sopt?x.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(x.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;b.rules.push({field:x.name,op:c[0],data:""});d.reDraw();return!1});k.append(h)}null!==c&&(h=a("<input type='button' value='-' title='Delete group' class='delete-group'/>"),k.append(h),h.bind("click",function(){for(e=0;e<c.groups.length;e++)if(c.groups[e]===b){c.groups.splice(e,1);break}d.reDraw();d.onchange();return!1}));if(void 0!==b.groups)for(e=
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    0;e<b.groups.length;e++)k=a("<tr></tr>"),g.append(k),h=a("<td class='first'></td>"),k.append(h),h=a("<td colspan='4'></td>"),h.append(this.createTableForGroup(b.groups[e],b)),k.append(h);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)g.append(this.createTableRowForRule(b.rules[e],b));return g};this.createTableRowForRule=function(b,c){var d=this,e=a("#"+a.jgrid.jqID(f.id))[0]||null,g=a("<tr></tr>"),h,l,w,u,x="",y;g.append("<td class='first'></td>");
    var A=a("<td class='columns'></td>");g.append(A);var B=a("<select></select>"),J,C=[];A.append(B);B.bind("change",function(){b.field=a(B).val();w=a(this).parents("tr:first");for(h=0;h<d.p.columns.length;h++)if(d.p.columns[h].name===b.field){u=d.p.columns[h];break}if(u){u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);var c=a.jgrid.createEl.call(e,u.inputtype,u.searchoptions,"",!0,d.p.ajaxSelectOptions||{},!0);a(c).addClass("input-elm");l=
        u.searchoptions.sopt?u.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(u.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;var f="",g=0;C=[];a.each(d.p.ops,function(){C.push(this.oper)});for(h=0;h<l.length;h++)J=a.inArray(l[h],C),-1!==J&&(0===g&&(b.op=d.p.ops[J].oper),f+="<option value='"+d.p.ops[J].oper+"'>"+d.p.ops[J].text+"</option>",g++);a(".selectopts",w).empty().append(f);a(".selectopts",w)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",w)[0].offsetWidth,
            10)+1,a(".selectopts",w).width(f),a(".selectopts",w).css("width","auto"));a(".data",w).empty().append(c);a.jgrid.bindEv.call(e,c,u.searchoptions);a(".input-elm",w).bind("change",function(c){c=c.target;b.data="SPAN"===c.nodeName.toUpperCase()&&u.searchoptions&&a.isFunction(u.searchoptions.custom_value)?u.searchoptions.custom_value.call(e,a(c).children(".customelement:first"),"get"):c.value;d.onchange()});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(h=A=0;h<d.p.columns.length;h++){y=
        void 0===d.p.columns[h].search?!0:d.p.columns[h].search;var M=!0===d.p.columns[h].hidden;if(!0===d.p.columns[h].searchoptions.searchhidden&&y||y&&!M)y="",b.field===d.p.columns[h].name&&(y=" selected='selected'",A=h),x+="<option value='"+d.p.columns[h].name+"'"+y+">"+d.p.columns[h].label+"</option>"}B.append(x);x=a("<td class='operators'></td>");g.append(x);u=f.columns[A];u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);A=a.jgrid.createEl.call(e,
        u.inputtype,u.searchoptions,b.data,!0,d.p.ajaxSelectOptions||{},!0);if("nu"===b.op||"nn"===b.op)a(A).attr("readonly","true"),a(A).attr("disabled","true");var H=a("<select class='selectopts'></select>");x.append(H);H.bind("change",function(){b.op=a(H).val();w=a(this).parents("tr:first");var c=a(".input-elm",w)[0];"nu"===b.op||"nn"===b.op?(b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=""),c.setAttribute("readonly","true"),c.setAttribute("disabled","true")):("SELECT"===c.tagName.toUpperCase()&&
    (b.data=c.value),c.removeAttribute("readonly"),c.removeAttribute("disabled"));d.onchange()});l=u.searchoptions.sopt?u.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(u.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;x="";a.each(d.p.ops,function(){C.push(this.oper)});for(h=0;h<l.length;h++)J=a.inArray(l[h],C),-1!==J&&(y=b.op===d.p.ops[J].oper?" selected='selected'":"",x+="<option value='"+d.p.ops[J].oper+"'"+y+">"+d.p.ops[J].text+"</option>");H.append(x);x=a("<td class='data'></td>");g.append(x);
    x.append(A);a.jgrid.bindEv.call(e,A,u.searchoptions);a(A).addClass("input-elm").bind("change",function(){b.data="custom"===u.inputtype?u.searchoptions.custom_value.call(e,a(this).children(".customelement:first"),"get"):a(this).val();d.onchange()});x=a("<td></td>");g.append(x);!0===this.p.ruleButtons&&(A=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),x.append(A),A.bind("click",function(){for(h=0;h<c.rules.length;h++)if(c.rules[h]===b){c.rules.splice(h,1);break}d.reDraw();
...
h&&(h=!0);h&&a.isFunction(d.beforeShowSearch)&&(h=d.beforeShowSearch.call(f,b));h&&(a.jgrid.viewModal("#"+a.jgrid.jqID(k.themodal),{gbox:"#gbox_"+a.jgrid.jqID(c),jqm:d.jqModal,modal:d.modal,overlay:d.overlay,toTop:d.toTop}),a(f).triggerHandler("jqGridFilterAfterShow",[b]),a.isFunction(d.afterShowSearch)&&d.afterShowSearch.call(f,b))}var f=this;if(f.grid){var c="fbox_"+f.p.id,h=!0,g=!0,k={themodal:"searchmod"+c,modalhead:"searchhd"+c,modalcontent:"searchcnt"+c,scrollelm:c},l=f.p.postData[d.sFilter];
    "string"===typeof l&&(l=a.jgrid.parse(l));!0===d.recreateFilter&&a("#"+a.jgrid.jqID(k.themodal)).remove();if(void 0!==a("#"+a.jgrid.jqID(k.themodal))[0])b(a("#fbox_"+a.jgrid.jqID(+f.p.id)));else{var m=a("<div><div id='"+c+"' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_"+a.jgrid.jqID(f.p.id)),p="left",r="";"rtl"===f.p.direction&&(p="right",r=" style='text-align:left'",m.attr("dir","rtl"));var q=a.extend([],f.p.colModel),n="<a id='"+c+"_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>"+
        d.Find+"</a>",t="<a id='"+c+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+d.Reset+"</a>",v="",w="",u,x=!1,y=-1;d.showQuery&&(v="<a id='"+c+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");d.columns.length?(q=d.columns,y=0,u=q[0].index||q[0].name):a.each(q,function(a,b){b.label||(b.label=f.p.colNames[a]);if(!x){var c=
        void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!d)x=!0,u=b.index||b.name,y=a}});if(!l&&u||!1===d.multipleSearch){var A="eq";0<=y&&q[y].searchoptions&&q[y].searchoptions.sopt?A=q[y].searchoptions.sopt[0]:d.sopt&&d.sopt.length&&(A=d.sopt[0]);l={groupOp:"AND",rules:[{field:u,op:A,data:""}]}}x=!1;d.tmplNames&&d.tmplNames.length&&(x=!0,w=d.tmplLabel,w+="<select class='ui-template'>",w+="<option value='default'>Default</option>",a.each(d.tmplNames,
        function(a,b){w+="<option value='"+a+"'>"+b+"</option>"}),w+="</select>");p="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+c+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+p+"'>"+t+w+"</td><td class='EditButton' "+r+">"+v+n+"</td></tr></tbody></table>";c=a.jgrid.jqID(c);a("#"+c).jqFilter({columns:q,filter:d.loadDefaults?l:null,showQuery:d.showQuery,errorcheck:d.errorcheck,sopt:d.sopt,
    ...
    break;case "password":case "text":case "textarea":case "button":z[this.name]=a(this).val()}n.p.autoencode&&(z[this.name]=a.jgrid.htmlEncode(z[this.name]))}});return!0}function c(b,c,e,f){var g,k,h,l=0,m,p,q,r=[],t=!1,x="",u;for(u=1;u<=f;u++)x+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==b&&(t=a(c).jqGrid("getInd",b));a(c.p.colModel).each(function(u){g=this.name;p=(k=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";
    if("cb"!==g&&"subgrid"!==g&&!0===this.editable&&"rn"!==g){if(!1===t)m="";else if(g===c.p.ExpandColumn&&!0===c.p.treeGrid)m=a("td[role='gridcell']:eq("+u+")",c.rows[t]).text();else{try{m=a.unformat.call(c,a("td[role='gridcell']:eq("+u+")",c.rows[t]),{rowId:b,colModel:this},u)}catch(w){m=this.edittype&&"textarea"===this.edittype?a("td[role='gridcell']:eq("+u+")",c.rows[t]).text():a("td[role='gridcell']:eq("+u+")",c.rows[t]).html()}if(!m||"&nbsp;"===m||"&#160;"===m||1===m.length&&160===m.charCodeAt(0))m=
        ""}var y=a.extend({},this.editoptions||{},{id:g,name:g}),C=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),A=parseInt(C.rowpos,10)||l+1,B=parseInt(2*(parseInt(C.colpos,10)||1),10);"_empty"===b&&y.defaultValue&&(m=a.isFunction(y.defaultValue)?y.defaultValue.call(n):y.defaultValue);this.edittype||(this.edittype="text");n.p.autoencode&&(m=a.jgrid.htmlDecode(m));q=a.jgrid.createEl.call(n,this.edittype,y,m,!1,a.extend({},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||
        {}));if(d[n.p.id].checkOnSubmit||d[n.p.id].checkOnUpdate)d[n.p.id]._savedData[g]=m;a(q).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(q).addClass("ui-widget-content ui-corner-all");h=a(e).find("tr[rowpos="+A+"]");if(C.rowabove){var z=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+C.rowcontent+"</td></tr>");a(e).append(z);z[0].rp=A}0===h.length&&(h=a("<tr "+p+" rowpos='"+A+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(h).append(x),a(e).append(h),
        h[0].rp=A);a("td:eq("+(B-2)+")",h[0]).html(void 0===C.label?c.p.colNames[u]:C.label);a("td:eq("+(B-1)+")",h[0]).append(C.elmprefix).append(q).append(C.elmsuffix);"custom"===this.edittype&&a.isFunction(y.custom_value)&&y.custom_value.call(n,a("#"+g,"#"+v),"set",m);a.jgrid.bindEv.call(n,q,y);r[l]=u;l++}});0<l&&(u=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+c.p.id+"_id' value='"+
...
d[n.p.id].checkOnUpdate)&&(d[n.p.id]._savedData[f]=m)}),a("#id_g","#"+e).val(b);else{var r=a(c).jqGrid("getInd",b,!0);r&&(a('td[role="gridcell"]',r).each(function(h){f=q[h].name;if("cb"!==f&&"subgrid"!==f&&"rn"!==f&&!0===q[h].editable){if(f===c.p.ExpandColumn&&!0===c.p.treeGrid)k=a(this).text();else try{k=a.unformat.call(c,a(this),{rowId:b,colModel:q[h]},h)}catch(l){k="textarea"===q[h].edittype?a(this).text():a(this).html()}n.p.autoencode&&(k=a.jgrid.htmlDecode(k));if(!0===d[n.p.id].checkOnSubmit||
    ...
    a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,p.message,a.jgrid.edit.bClose)}}g++}}),0<g&&a("#id_g",u).val(b))}}function g(){a.each(n.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&z.hasOwnProperty(b.name)&&""===z[b.name]&&(z[b.name]="null")})}function k(){var c,e=[!0,"",""],f={},k=n.p.prmNames,l,m,p,q,r,y=a(n).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+v),D]);y&&"object"===typeof y&&(z=y);a.isFunction(d[n.p.id].beforeCheckValues)&&(y=d[n.p.id].beforeCheckValues.call(n,
    z,a("#"+v),D))&&"object"===typeof y&&(z=y);for(p in z)if(z.hasOwnProperty(p)&&(e=a.jgrid.checkValues.call(n,z[p],p),!1===e[0]))break;g();e[0]&&(f=a(n).triggerHandler("jqGridAddEditClickSubmit",[d[n.p.id],z,D]),void 0===f&&a.isFunction(d[n.p.id].onclickSubmit)&&(f=d[n.p.id].onclickSubmit.call(n,d[n.p.id],z,D)||{}),e=a(n).triggerHandler("jqGridAddEditBeforeSubmit",[z,a("#"+v),D]),void 0===e&&(e=[!0,"",""]),e[0]&&a.isFunction(d[n.p.id].beforeSubmit)&&(e=d[n.p.id].beforeSubmit.call(n,z,a("#"+v),D)));
    ...
    (f=n.p.treeReader[r],!z.hasOwnProperty(f)||z[m]===k.addoper&&"parent_id_field"===r||delete z[f]);z[l]=a.jgrid.stripPref(n.p.idPrefix,z[l]);r=a.extend({url:d[n.p.id].url||a(n).jqGrid("getGridParam","editurl"),type:d[n.p.id].mtype,data:a.isFunction(d[n.p.id].serializeEditData)?d[n.p.id].serializeEditData.call(n,z):z,complete:function(f,g){var p;z[l]=n.p.idPrefix+z[l];300<=f.status&&304!==f.status?(e[0]=!1,e[1]=a(n).triggerHandler("jqGridAddEditErrorTextFormat",[f,D]),a.isFunction(d[n.p.id].errorTextFormat)?
        e[1]=d[n.p.id].errorTextFormat.call(n,f,D):e[1]=g+" Status: '"+f.statusText+"'. Error code: "+f.status):(e=a(n).triggerHandler("jqGridAddEditAfterSubmit",[f,z,D]),void 0===e&&(e=[!0,"",""]),e[0]&&a.isFunction(d[n.p.id].afterSubmit)&&(e=d[n.p.id].afterSubmit.call(n,f,z,D)));if(!1===e[0])a("#FormError>td",u).html(e[1]),a("#FormError",u).show();else if(n.p.autoencode&&a.each(z,function(b,c){z[b]=a.jgrid.htmlDecode(c)}),z[m]===k.addoper?(e[2]||(e[2]=a.jgrid.randId()),z[l]=e[2],d[n.p.id].reloadAfterSubmit?
            a(n).trigger("reloadGrid"):!0===n.p.treeGrid?a(n).jqGrid("addChildNode",e[2],q,z):a(n).jqGrid("addRowData",e[2],z,b.addedrow),d[n.p.id].closeAfterAdd?(!0!==n.p.treeGrid&&a(n).jqGrid("setSelection",e[2]),a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:b.jqModal,onClose:d[n.p.id].onClose})):d[n.p.id].clearAfterAdd&&h("_empty",n,v)):(d[n.p.id].reloadAfterSubmit?(a(n).trigger("reloadGrid"),d[n.p.id].closeAfterEdit||setTimeout(function(){a(n).jqGrid("setSelection",z[l])},
            1E3)):!0===n.p.treeGrid?a(n).jqGrid("setTreeRow",z[l],z):a(n).jqGrid("setRowData",z[l],z),d[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:b.jqModal,onClose:d[n.p.id].onClose})),a.isFunction(d[n.p.id].afterComplete)&&(c=f,setTimeout(function(){a(n).triggerHandler("jqGridAddEditAfterComplete",[c,z,a("#"+v),D]);d[n.p.id].afterComplete.call(n,c,z,a("#"+v),D);c=null},500)),d[n.p.id].checkOnSubmit||d[n.p.id].checkOnUpdate)if(a("#"+v).data("disabled",
        ...
        r,"set_"+n.p.id),void 0===f&&(f=[!0,""]),!1===f[0]?(e[0]=!1,e[1]=f[1]||"Error deleting the selected row!"):(r.data.oper===k.addoper&&d[n.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:b.jqModal,onClose:d[n.p.id].onClose}),r.data.oper===k.editoper&&d[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:b.jqModal,onClose:d[n.p.id].onClose}))):a.ajax(r))}!1===e[0]&&(a("#FormError>td",u).html(e[1]),
        a("#FormError",u).show())}function l(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&a[d]!=b[d]){c=!0;break}return c}function m(){var b=!0;a("#FormError",u).hide();d[n.p.id].checkOnUpdate&&(z={},f(),E=l(z,d[n.p.id]._savedData))&&(a("#"+v).data("disabled",!0),a(".confirm","#"+x.themodal).show(),b=!1);return b}function p(){var b;if("_empty"!==e&&void 0!==n.p.savedRow&&0<n.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<n.p.savedRow.length;b++)if(n.p.savedRow[b].id==e){a(n).jqGrid("restoreRow",
    ...
    function q(){var b=a(n).jqGrid("getDataIDs"),c=a("#id_g",u).val();return[a.inArray(c,b),b]}var n=this;if(n.grid&&e){var t=n.p.id,v="FrmGrid_"+t,w="TblGrid_"+t,u="#"+a.jgrid.jqID(w),x={themodal:"editmod"+t,modalhead:"edithd"+t,modalcontent:"editcnt"+t,scrollelm:v},y=a.isFunction(d[n.p.id].beforeShowForm)?d[n.p.id].beforeShowForm:!1,A=a.isFunction(d[n.p.id].afterShowForm)?d[n.p.id].afterShowForm:!1,B=a.isFunction(d[n.p.id].beforeInitData)?d[n.p.id].beforeInitData:!1,J=a.isFunction(d[n.p.id].onInitializeForm)?
        d[n.p.id].onInitializeForm:!1,C=!0,M=1,H=0,z,E,D,v=a.jgrid.jqID(v);"new"===e?(e="_empty",D="add",b.caption=d[n.p.id].addCaption):(b.caption=d[n.p.id].editCaption,D="edit");b.recreateForm||a(n).data("formProp")&&a.extend(d[a(this)[0].p.id],a(n).data("formProp"));var Q=!0;b.checkOnUpdate&&b.jqModal&&!b.modal&&(Q=!1);var W=isNaN(d[a(this)[0].p.id].dataheight)?d[a(this)[0].p.id].dataheight:d[a(this)[0].p.id].dataheight+"px",C=isNaN(d[a(this)[0].p.id].datawidth)?d[a(this)[0].p.id].datawidth:d[a(this)[0].p.id].datawidth+
    "px",W=a("<form name='FormPost' id='"+v+"' class='FormGrid' onSubmit='return false;' style='width:"+C+";overflow:auto;position:relative;height:"+W+";'></form>").data("disabled",!1),Y=a("<table id='"+w+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),C=a(n).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+v),D]);void 0===C&&(C=!0);C&&B&&(C=B.call(n,a("#"+v),D));if(!1!==C){p();a(n.p.colModel).each(function(){var a=this.formoptions;M=Math.max(M,a?a.colpos||
    0:0);H=Math.max(H,a?a.rowpos||0:0)});a(W).append(Y);B=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+2*M+"'></td></tr>");B[0].rp=0;a(Y).append(B);B=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*M+"'>"+d[n.p.id].topinfo+"</td></tr>");B[0].rp=0;a(Y).append(B);var C=(B="rtl"===n.p.direction?!0:!1)?"nData":"pData",F=B?"pData":"nData";c(e,n,Y,M);var C="<a id='"+C+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
        F="<a id='"+F+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",ca="<a id='sData' class='fm-button ui-state-default ui-corner-all'>"+b.bSubmit+"</a>",T="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bCancel+"</a>",w="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+w+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+
            (B?F+C:C+F)+"</td><td class='EditButton'>"+ca+T+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+d[n.p.id].bottominfo+"</td></tr>"),w=w+"</tbody></table>";if(0<H){var Z=[];a.each(a(Y)[0].rows,function(a,b){Z[a]=b});Z.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(Z,function(b,c){a("tbody",Y).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(t);var ia=!1;!0===b.closeOnEscape&&(b.closeOnEscape=!1,ia=!0);w=a("<div></div>").append(W).append(w);a.jgrid.createModal(x,
        w,d[a(this)[0].p.id],"#gview_"+a.jgrid.jqID(n.p.id),a("#gbox_"+a.jgrid.jqID(n.p.id))[0]);B&&(a("#pData, #nData",u+"_2").css("float","right"),a(".EditButton",u+"_2").css("text-align","left"));d[n.p.id].topinfo&&a(".tinfo",u).show();d[n.p.id].bottominfo&&a(".binfo",u+"_2").show();w=w=null;a("#"+a.jgrid.jqID(x.themodal)).keydown(function(c){var e=c.target;if(!0===a("#"+v).data("disabled"))return!1;if(!0===d[n.p.id].savekey[0]&&c.which===d[n.p.id].savekey[1]&&"TEXTAREA"!==e.tagName)return a("#sData",
        u+"_2").trigger("click"),!1;if(27===c.which){if(!m())return!1;ia&&a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:b.gbox,jqm:b.jqModal,onClose:d[n.p.id].onClose});return!1}if(!0===d[n.p.id].navkeys[0]){if("_empty"===a("#id_g",u).val())return!0;if(c.which===d[n.p.id].navkeys[1])return a("#pData",u+"_2").trigger("click"),!1;if(c.which===d[n.p.id].navkeys[2])return a("#nData",u+"_2").trigger("click"),!1}});b.checkOnUpdate&&(a("a.ui-jqdialog-titlebar-close span","#"+a.jgrid.jqID(x.themodal)).removeClass("jqmClose"),
        a("a.ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(x.themodal)).unbind("click").click(function(){if(!m())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:b.jqModal,onClose:d[n.p.id].onClose});return!1}));b.saveicon=a.extend([!0,"left","ui-icon-disk"],b.saveicon);b.closeicon=a.extend([!0,"left","ui-icon-close"],b.closeicon);!0===b.saveicon[0]&&a("#sData",u+"_2").addClass("right"===b.saveicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+
        b.saveicon[2]+"'></span>");!0===b.closeicon[0]&&a("#cData",u+"_2").addClass("right"===b.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.closeicon[2]+"'></span>");if(d[n.p.id].checkOnSubmit||d[n.p.id].checkOnUpdate)ca="<a id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bYes+"</a>",F="<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bNo+"</a>",T="<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+
        b.bExit+"</a>",w=b.zIndex||999,w++,a("<div class='"+b.overlayClass+" jqgrid-overlay confirm' style='z-index:"+w+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(w+1)+"'>"+b.saveData+"<br/><br/>"+ca+F+T+"</div>").insertAfter("#"+v),a("#sNew","#"+a.jgrid.jqID(x.themodal)).click(function(){k();a("#"+v).data("disabled",!1);a(".confirm","#"+a.jgrid.jqID(x.themodal)).hide();return!1}),a("#nNew","#"+a.jgrid.jqID(x.themodal)).click(function(){a(".confirm",
        "#"+a.jgrid.jqID(x.themodal)).hide();a("#"+v).data("disabled",!1);setTimeout(function(){a(":input:visible","#"+v)[0].focus()},0);return!1}),a("#cNew","#"+a.jgrid.jqID(x.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(x.themodal)).hide();a("#"+v).data("disabled",!1);a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:b.jqModal,onClose:d[n.p.id].onClose});return!1});a(n).triggerHandler("jqGridAddEditInitializeForm",[a("#"+v),D]);J&&J.call(n,a("#"+v),D);"_empty"!==
    e&&d[n.p.id].viewPagerButtons?a("#pData,#nData",u+"_2").show():a("#pData,#nData",u+"_2").hide();a(n).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+v),D]);y&&y.call(n,a("#"+v),D);a("#"+a.jgrid.jqID(x.themodal)).data("onClose",d[n.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(x.themodal),{gbox:"#gbox_"+a.jgrid.jqID(t),jqm:b.jqModal,overlay:b.overlay,modal:b.modal,overlayClass:b.overlayClass,onHide:function(b){a(n).data("formProp",{top:parseFloat(a(b.w).css("top")),left:parseFloat(a(b.w).css("left")),
        width:a(b.w).width(),height:a(b.w).height(),dataheight:a("#"+v).height(),datawidth:a("#"+v).width()});b.w.remove();b.o&&b.o.remove()}});Q||a("."+a.jgrid.jqID(b.overlayClass)).click(function(){if(!m())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:b.jqModal,onClose:d[n.p.id].onClose});return!1});a(".fm-button","#"+a.jgrid.jqID(x.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",u+"_2").click(function(){z=
    {};a("#FormError",u).hide();f();"_empty"===z[n.p.id+"_id"]?k():!0===b.checkOnSubmit?(E=l(z,d[n.p.id]._savedData))?(a("#"+v).data("disabled",!0),a(".confirm","#"+a.jgrid.jqID(x.themodal)).show()):k():k();return!1});a("#cData",u+"_2").click(function(){if(!m())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(x.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:b.jqModal,onClose:d[n.p.id].onClose});return!1});a("#nData",u+"_2").click(function(){if(!m())return!1;a("#FormError",u).hide();var c=q();c[0]=parseInt(c[0],
        10);if(-1!==c[0]&&c[1][c[0]+1]){a(n).triggerHandler("jqGridAddEditClickPgButtons",["next",a("#"+v),c[1][c[0]]]);var d;if(a.isFunction(b.onclickPgButtons)&&(d=b.onclickPgButtons.call(n,"next",a("#"+v),c[1][c[0]]),void 0!==d&&!1===d)||a("#"+a.jgrid.jqID(c[1][c[0]+1])).hasClass("ui-state-disabled"))return!1;h(c[1][c[0]+1],n,v);a(n).jqGrid("setSelection",c[1][c[0]+1]);a(n).triggerHandler("jqGridAddEditAfterClickPgButtons",["next",a("#"+v),c[1][c[0]]]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(n,
        "next",a("#"+v),c[1][c[0]+1]);r(c[0]+1,c)}return!1});a("#pData",u+"_2").click(function(){if(!m())return!1;a("#FormError",u).hide();var c=q();if(-1!==c[0]&&c[1][c[0]-1]){a(n).triggerHandler("jqGridAddEditClickPgButtons",["prev",a("#"+v),c[1][c[0]]]);var d;if(a.isFunction(b.onclickPgButtons)&&(d=b.onclickPgButtons.call(n,"prev",a("#"+v),c[1][c[0]]),void 0!==d&&!1===d)||a("#"+a.jgrid.jqID(c[1][c[0]-1])).hasClass("ui-state-disabled"))return!1;h(c[1][c[0]-1],n,v);a(n).jqGrid("setSelection",c[1][c[0]-1]);
        a(n).triggerHandler("jqGridAddEditAfterClickPgButtons",["prev",a("#"+v),c[1][c[0]]]);a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(n,"prev",a("#"+v),c[1][c[0]-1]);r(c[0]-1,c)}return!1});a(n).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+v),D]);A&&A.call(n,a("#"+v),D);y=q();r(y[0],y)}}})},viewGridRow:function(e,b){b=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,jqModal:!0,closeOnEscape:!1,labelswidth:"30%",
    closeicon:[],navkeys:[!1,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0,recreateForm:!1},a.jgrid.view,b||{});d[a(this)[0].p.id]=b;return this.each(function(){function f(){!0!==d[l.p.id].closeOnEscape&&!0!==d[l.p.id].navkeys[0]||setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(t.modalhead)).focus()},0)}function c(c,d,e,f){var g,k,h,l=0,m,n,p=[],q=!1,r,t="<td class='CaptionTD form-view-label ui-widget-content' width='"+b.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",
    x="",u=["integer","number","currency"],v=0,y=0,w,A,B;for(r=1;r<=f;r++)x+=1===r?t:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){(k=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,u)?v=Math.max(v,parseInt(this.width,10)):y=Math.max(y,parseInt(this.width,10)))});w=0!==v?v:0!==y?y:0;q=a(d).jqGrid("getInd",
    c);a(d.p.colModel).each(function(b){g=this.name;A=!1;n=(k=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";B="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&B){m=!1===q?"":g===d.p.ExpandColumn&&!0===d.p.treeGrid?a("td:eq("+b+")",d.rows[q]).text():a("td:eq("+b+")",d.rows[q]).html();A="right"===this.align&&0!==w?!0:!1;var c=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),r=parseInt(c.rowpos,10)||
    l+1,t=parseInt(2*(parseInt(c.colpos,10)||1),10);if(c.rowabove){var u=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+c.rowcontent+"</td></tr>");a(e).append(u);u[0].rp=r}h=a(e).find("tr[rowpos="+r+"]");0===h.length&&(h=a("<tr "+n+" rowpos='"+r+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(h).append(x),a(e).append(h),h[0].rp=r);a("td:eq("+(t-2)+")",h[0]).html("<b>"+(void 0===c.label?d.p.colNames[b]:c.label)+"</b>");a("td:eq("+(t-1)+")",h[0]).append("<span>"+m+"</span>").attr("id","v_"+g);
    A&&a("td:eq("+(t-1)+") span",h[0]).css({"text-align":"right",width:w+"px"});p[l]=b;l++}});0<l&&(c=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+c+"'/></td></tr>"),c[0].rp=l+99,a(e).append(c));return p}function h(b,c){var d,e,f=0,g,k;if(k=a(c).jqGrid("getInd",b,!0))a("td",k).each(function(b){d=c.p.colModel[b].name;e=c.p.colModel[b].editrules&&!0===c.p.colModel[b].editrules.edithidden?
    ...
    m,n="ViewTbl_"+m,t={themodal:"viewmod"+m,modalhead:"viewhd"+m,modalcontent:"viewcnt"+m,scrollelm:p},v=a.isFunction(d[l.p.id].beforeInitData)?d[l.p.id].beforeInitData:!1,w=!0,u=1,x=0;b.recreateForm||a(l).data("viewProp")&&a.extend(d[a(this)[0].p.id],a(l).data("viewProp"));var y=isNaN(d[a(this)[0].p.id].dataheight)?d[a(this)[0].p.id].dataheight:d[a(this)[0].p.id].dataheight+"px",A=isNaN(d[a(this)[0].p.id].datawidth)?d[a(this)[0].p.id].datawidth:d[a(this)[0].p.id].datawidth+"px",q=a("<form name='FormPost' id='"+
    q+"' class='FormGrid' style='width:"+A+";overflow:auto;position:relative;height:"+y+";'></form>"),B=a("<table id='"+n+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");v&&(w=v.call(l,a("#"+p)),void 0===w&&(w=!0));if(!1!==w){a(l.p.colModel).each(function(){var a=this.formoptions;u=Math.max(u,a?a.colpos||0:0);x=Math.max(x,a?a.rowpos||0:0)});a(q).append(B);c(e,l,B,u);n="rtl"===l.p.direction?!0:!1;v="<a id='"+(n?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
    w="<a id='"+(n?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";y="<a id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bClose+"</a>";if(0<x){var J=[];a.each(a(B)[0].rows,function(a,b){J[a]=b});J.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(J,function(b,c){a("tbody",B).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(m);q=a("<div></div>").append(q).append("<table border='0' class='EditTable' id='"+
        r+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+b.labelswidth+"'>"+(n?w+v:v+w)+"</td><td class='EditButton'>"+y+"</td></tr></tbody></table>");a.jgrid.createModal(t,q,b,"#gview_"+a.jgrid.jqID(l.p.id),a("#gview_"+a.jgrid.jqID(l.p.id))[0]);n&&(a("#pData, #nData","#"+r+"_2").css("float","right"),a(".EditButton","#"+r+"_2").css("text-align","left"));b.viewPagerButtons||a("#pData, #nData","#"+r+"_2").hide();q=null;a("#"+t.themodal).keydown(function(c){if(27===c.which)return d[l.p.id].closeOnEscape&&
    a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:b.gbox,jqm:b.jqModal,onClose:b.onClose}),!1;if(!0===b.navkeys[0]){if(c.which===b.navkeys[1])return a("#pData","#"+r+"_2").trigger("click"),!1;if(c.which===b.navkeys[2])return a("#nData","#"+r+"_2").trigger("click"),!1}});b.closeicon=a.extend([!0,"left","ui-icon-close"],b.closeicon);!0===b.closeicon[0]&&a("#cData","#"+r+"_2").addClass("right"===b.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.closeicon[2]+
        "'></span>");a.isFunction(b.beforeShowForm)&&b.beforeShowForm.call(l,a("#"+p));a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(m),jqm:b.jqModal,overlay:b.overlay,modal:b.modal,onHide:function(b){a(l).data("viewProp",{top:parseFloat(a(b.w).css("top")),left:parseFloat(a(b.w).css("left")),width:a(b.w).width(),height:a(b.w).height(),dataheight:a("#"+p).height(),datawidth:a("#"+p).width()});b.w.remove();b.o&&b.o.remove()}});a(".fm-button:not(.ui-state-disabled)","#"+r+"_2").hover(function(){a(this).addClass("ui-state-hover")},
        function(){a(this).removeClass("ui-state-hover")});f();a("#cData","#"+r+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(m),jqm:b.jqModal,onClose:b.onClose});return!1});a("#nData","#"+r+"_2").click(function(){a("#FormError","#"+r).hide();var c=k();c[0]=parseInt(c[0],10);-1!==c[0]&&c[1][c[0]+1]&&(a.isFunction(b.onclickPgButtons)&&b.onclickPgButtons.call(l,"next",a("#"+p),c[1][c[0]]),h(c[1][c[0]+1],l),a(l).jqGrid("setSelection",c[1][c[0]+1]),a.isFunction(b.afterclickPgButtons)&&
    ...
    e){var c=a.isFunction(d[f.p.id].beforeShowForm),h=a.isFunction(d[f.p.id].afterShowForm),g=a.isFunction(d[f.p.id].beforeInitData)?d[f.p.id].beforeInitData:!1,k=f.p.id,l={},m=!0,p="DelTbl_"+a.jgrid.jqID(k),r,q,n,t,v="DelTbl_"+k,w={themodal:"delmod"+k,modalhead:"delhd"+k,modalcontent:"delcnt"+k,scrollelm:p};a.isArray(e)&&(e=e.join());if(void 0!==a("#"+a.jgrid.jqID(w.themodal))[0]){g&&(m=g.call(f,a("#"+p)),void 0===m&&(m=!0));if(!1===m)return;a("#DelData>td","#"+p).text(e);a("#DelError","#"+p).hide();
    !0===d[f.p.id].processing&&(d[f.p.id].processing=!1,a("#dData","#"+p).removeClass("ui-state-active"));c&&d[f.p.id].beforeShowForm.call(f,a("#"+p));a.jgrid.viewModal("#"+a.jgrid.jqID(w.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:d[f.p.id].jqModal,jqM:!1,overlay:d[f.p.id].overlay,modal:d[f.p.id].modal})}else{var u=isNaN(d[f.p.id].dataheight)?d[f.p.id].dataheight:d[f.p.id].dataheight+"px",x=isNaN(b.datawidth)?b.datawidth:b.datawidth+"px",v="<div id='"+v+"' class='formdata' style='width:"+x+";overflow:auto;position:relative;height:"+
    u+";'><table class='DelTable'><tbody>",v=v+"<tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>",v=v+("<tr id='DelData' style='display:none'><td >"+e+"</td></tr>"),v=v+('<tr><td class="delmsg" style="white-space:pre;">'+d[f.p.id].msg+"</td></tr><tr><td >&#160;</td></tr>"),v=v+"</tbody></table></div>",v=v+("<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='"+p+"_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>"+
    ("<a id='dData' class='fm-button ui-state-default ui-corner-all'>"+b.bSubmit+"</a>")+"&#160;"+("<a id='eData' class='fm-button ui-state-default ui-corner-all'>"+b.bCancel+"</a>")+"</td></tr></tbody></table>");b.gbox="#gbox_"+a.jgrid.jqID(k);a.jgrid.createModal(w,v,b,"#gview_"+a.jgrid.jqID(f.p.id),a("#gview_"+a.jgrid.jqID(f.p.id))[0]);g&&(m=g.call(f,a("#"+p)),void 0===m&&(m=!0));if(!1===m)return;a(".fm-button","#"+p+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});
    ...
    a("#dData","#"+p+"_2").click(function(){var c=[!0,""],e,g=a("#DelData>td","#"+p).text();l={};a.isFunction(d[f.p.id].onclickSubmit)&&(l=d[f.p.id].onclickSubmit.call(f,d[f.p.id],g)||{});a.isFunction(d[f.p.id].beforeSubmit)&&(c=d[f.p.id].beforeSubmit.call(f,g));if(c[0]&&!d[f.p.id].processing){d[f.p.id].processing=!0;n=f.p.prmNames;r=a.extend({},d[f.p.id].delData,l);t=n.oper;r[t]=n.deloper;q=n.id;g=String(g).split(",");if(!g.length)return!1;for(e in g)g.hasOwnProperty(e)&&(g[e]=a.jgrid.stripPref(f.p.idPrefix,
        ...
        p+"_2").removeClass("ui-state-active");c[0]&&a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,onClose:d[f.p.id].onClose})}},a.jgrid.ajaxOptions,d[f.p.id].ajaxDelOptions);e.url||d[f.p.id].useDataProxy||(a.isFunction(f.p.dataProxy)?d[f.p.id].useDataProxy=!0:(c[0]=!1,c[1]+=" "+a.jgrid.errors.nourl));c[0]&&(d[f.p.id].useDataProxy?(e=f.p.dataProxy.call(f,e,"del_"+f.p.id),void 0===e&&(e=[!0,""]),!1===e[0]?(c[0]=!1,c[1]=e[1]||"Error deleting the selected row!"):a.jgrid.hideModal("#"+
        a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:b.jqModal,onClose:d[f.p.id].onClose})):a.ajax(e))}!1===c[0]&&(a("#DelError>td","#"+p).html(c[1]),a("#DelError","#"+p).show());return!1});a("#eData","#"+p+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:d[f.p.id].jqModal,onClose:d[f.p.id].onClose});return!1});c&&d[f.p.id].beforeShowForm.call(f,a("#"+p));a.jgrid.viewModal("#"+a.jgrid.jqID(w.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:d[f.p.id].jqModal,
        overlay:d[f.p.id].overlay,modal:d[f.p.id].modal})}h&&d[f.p.id].afterShowForm.call(f,a("#"+p));!0===d[f.p.id].closeOnEscape&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(w.modalhead)).focus()},0)}})},navGrid:function(d,b,f,c,h,g,k){b=a.extend({edit:!0,editicon:"ui-icon-pencil",add:!0,addicon:"ui-icon-plus",del:!0,delicon:"ui-icon-trash",search:!0,searchicon:"ui-icon-search",refresh:!0,refreshicon:"ui-icon-refresh",refreshstate:"firstpage",view:!1,viewicon:"ui-icon-document",
    ...
    drag:!0,resize:!0,caption:b.alertcap,top:b.alerttop,left:b.alertleft,width:b.alertwidth,height:b.alertheight,closeOnEscape:b.closeOnEscape,zIndex:b.alertzIndex},"#gview_"+a.jgrid.jqID(m.p.id),a("#gbox_"+a.jgrid.jqID(m.p.id))[0],!0));var r=1,q,n=function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},t=function(){a(this).removeClass("ui-state-hover")};b.cloneToTop&&m.p.toppager&&(r=2);for(q=0;q<r;q++){var v=a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
    w,u;0===q?(w=d,u=m.p.id,w===m.p.toppager&&(u+="_top",r=1)):(w=m.p.toppager,u=m.p.id+"_top");"rtl"===m.p.direction&&a(v).attr("dir","rtl").css("float","right");b.add&&(c=c||{},p=a("<td class='ui-pg-button ui-corner-all'></td>"),a(p).append("<div class='ui-pg-div'><span class='ui-icon "+b.addicon+"'></span>"+b.addtext+"</div>"),a("tr",v).append(p),a(p,v).attr({title:b.addtitle||"",id:c.id||"add_"+u}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(b.addfunc)?b.addfunc.call(m):
    a(m).jqGrid("editGridRow","new",c));return!1}).hover(n,t),p=null);b.edit&&(p=a("<td class='ui-pg-button ui-corner-all'></td>"),f=f||{},a(p).append("<div class='ui-pg-div'><span class='ui-icon "+b.editicon+"'></span>"+b.edittext+"</div>"),a("tr",v).append(p),a(p,v).attr({title:b.edittitle||"",id:f.id||"edit_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c=m.p.selrow;c?a.isFunction(b.editfunc)?b.editfunc.call(m,c):a(m).jqGrid("editGridRow",c,f):(a.jgrid.viewModal("#"+l.themodal,
    {gbox:"#gbox_"+a.jgrid.jqID(m.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,t),p=null);b.view&&(p=a("<td class='ui-pg-button ui-corner-all'></td>"),k=k||{},a(p).append("<div class='ui-pg-div'><span class='ui-icon "+b.viewicon+"'></span>"+b.viewtext+"</div>"),a("tr",v).append(p),a(p,v).attr({title:b.viewtitle||"",id:k.id||"view_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c=m.p.selrow;c?a.isFunction(b.viewfunc)?b.viewfunc.call(m,c):a(m).jqGrid("viewGridRow",c,k):
    (a.jgrid.viewModal("#"+l.themodal,{gbox:"#gbox_"+a.jgrid.jqID(m.p.id),jqm:!0}),a("#jqg_alrt").focus())}return!1}).hover(n,t),p=null);b.del&&(p=a("<td class='ui-pg-button ui-corner-all'></td>"),h=h||{},a(p).append("<div class='ui-pg-div'><span class='ui-icon "+b.delicon+"'></span>"+b.deltext+"</div>"),a("tr",v).append(p),a(p,v).attr({title:b.deltitle||"",id:h.id||"del_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var c;m.p.multiselect?(c=m.p.selarrrow,0===c.length&&(c=null)):c=
    ...
    b.searchicon+"'></span>"+b.searchtext+"</div>"),a("tr",v).append(p),a(p,v).attr({title:b.searchtitle||"",id:g.id||"search_"+u}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(b.searchfunc)?b.searchfunc.call(m,g):a(m).jqGrid("searchGrid",g));return!1}).hover(n,t),g.showOnLoad&&!0===g.showOnLoad&&a(p,v).click(),p=null);b.refresh&&(p=a("<td class='ui-pg-button ui-corner-all'></td>"),a(p).append("<div class='ui-pg-div'><span class='ui-icon "+b.refreshicon+"'></span>"+b.refreshtext+
    "</div>"),a("tr",v).append(p),a(p,v).attr({title:b.refreshtitle||"",id:"refresh_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){a.isFunction(b.beforeRefresh)&&b.beforeRefresh.call(m);m.p.search=!1;m.p.resetsearch=!0;try{var c=m.p.id;m.p.postData.filters="";try{a("#fbox_"+a.jgrid.jqID(c)).jqFilter("resetFilter")}catch(d){}a.isFunction(m.clearToolbar)&&m.clearToolbar.call(m,!1)}catch(e){}switch(b.refreshstate){case "firstpage":a(m).trigger("reloadGrid",[{page:1}]);break;case "current":a(m).trigger("reloadGrid",
    [{current:!0}])}a.isFunction(b.afterRefresh)&&b.afterRefresh.call(m)}return!1}).hover(n,t),p=null);p=a(".ui-jqgrid").css("font-size")||"11px";a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+p+";visibility:hidden;' ></div>");p=a(v).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(w+"_"+b.position,w).append(v);m.p._nvtd&&(p>m.p._nvtd[0]&&(a(w+"_"+b.position,w).width(p),m.p._nvtd[0]=p),m.p._nvtd[1]=p);v=p=p=null;this.nav=!0}}}})},navButtonAdd:function(d,
...
(function(a){a.jgrid.inlineEdit=a.jgrid.inlineEdit||{};a.jgrid.extend({editRow:function(d,e,b,f,c,h,g,k,l){var m={},p=a.makeArray(arguments).slice(1);"object"===a.type(p[0])?m=p[0]:(void 0!==e&&(m.keys=e),a.isFunction(b)&&(m.oneditfunc=b),a.isFunction(f)&&(m.successfunc=f),void 0!==c&&(m.url=c),void 0!==h&&(m.extraparam=h),a.isFunction(g)&&(m.aftersavefunc=g),a.isFunction(k)&&(m.errorfunc=k),a.isFunction(l)&&(m.afterrestorefunc=l));m=a.extend(!0,{keys:!1,oneditfunc:null,successfunc:null,url:null,
    ...
    b.p.ExpandColumn;if(l)e=a("span:first",this).html();else try{e=a.unformat.call(b,this,{rowId:d,colModel:p[f]},f)}catch(m){e=p[f].edittype&&"textarea"===p[f].edittype?a(this).text():a(this).html()}if("cb"!==c&&"subgrid"!==c&&"rn"!==c&&(b.p.autoencode&&(e=a.jgrid.htmlDecode(e)),h[c]=e,!0===p[f].editable)){null===k&&(k=f);l?a("span:first",this).html(""):a(this).html("");var t=a.extend({},p[f].editoptions||{},{id:d+"_"+c,name:c});p[f].edittype||(p[f].edittype="text");if("&nbsp;"===e||"&#160;"===e||1===
    e.length&&160===e.charCodeAt(0))e="";var x=a.jgrid.createEl.call(b,p[f].edittype,t,e,!0,a.extend({},a.jgrid.ajaxOptions,b.p.ajaxSelectOptions||{}));a(x).addClass("editable");l?a("span:first",this).append(x):a(this).append(x);a.jgrid.bindEv.call(b,x,t);"select"===p[f].edittype&&void 0!==p[f].editoptions&&!0===p[f].editoptions.multiple&&void 0===p[f].editoptions.dataUrl&&a.jgrid.msie&&a(x).width(a(x).width());g++}}),0<g&&(h.id=d,b.p.savedRow.push(h),a(l).attr("editable","1"),setTimeout(function(){a("td:eq("+
    k+") input",l).focus()},0),!0===m.keys&&a(l).bind("keydown",function(c){if(27===c.keyCode){a(b).jqGrid("restoreRow",d,m.afterrestorefunc);if(b.p._inlinenav)try{a(b).jqGrid("showAddEditButtons")}catch(e){}return!1}if(13===c.keyCode){if("TEXTAREA"===c.target.tagName)return!0;if(a(b).jqGrid("saveRow",d,m)&&b.p._inlinenav)try{a(b).jqGrid("showAddEditButtons")}catch(f){}return!1}}),a(b).triggerHandler("jqGridInlineEditRow",[d,m]),a.isFunction(m.oneditfunc)&&m.oneditfunc.call(b,d))))))})},saveRow:function(d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             e,b,f,c,h,g){var k=a.makeArray(arguments).slice(1),l={};"object"===a.type(k[0])?l=k[0]:(a.isFunction(e)&&(l.successfunc=e),void 0!==b&&(l.url=b),void 0!==f&&(l.extraparam=f),a.isFunction(c)&&(l.aftersavefunc=c),a.isFunction(h)&&(l.errorfunc=h),a.isFunction(g)&&(l.afterrestorefunc=g));var l=a.extend(!0,{successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,mtype:"POST"},a.jgrid.inlineEdit,l),m=!1,p=this[0],r,q={},n={},t={},v,w,u;if(!p.grid)return m;
    u=a(p).jqGrid("getInd",d,!0);if(!1===u)return m;k=a.isFunction(l.beforeSaveRow)?l.beforeSaveRow.call(p,l,d):void 0;void 0===k&&(k=!0);if(k){k=a(u).attr("editable");l.url=l.url||p.p.editurl;if("1"===k){var x;a('td[role="gridcell"]',u).each(function(b){x=p.p.colModel[b];r=x.name;if("cb"!==r&&"subgrid"!==r&&!0===x.editable&&"rn"!==r&&!a(this).hasClass("not-editable-cell")){switch(x.edittype){case "checkbox":var c=["Yes","No"];x.editoptions&&(c=x.editoptions.value.split(":"));q[r]=a("input",this).is(":checked")?
        c[0]:c[1];break;case "text":case "password":case "textarea":case "button":q[r]=a("input, textarea",this).val();break;case "select":if(x.editoptions.multiple){var c=a("select",this),d=[];q[r]=a(c).val();q[r]=q[r]?q[r].join(","):"";a("select option:selected",this).each(function(b,c){d[b]=a(c).text()});n[r]=d.join(",")}else q[r]=a("select option:selected",this).val(),n[r]=a("select option:selected",this).text();x.formatter&&"select"===x.formatter&&(n={});break;case "custom":try{if(x.editoptions&&a.isFunction(x.editoptions.custom_value)){if(q[r]=
            x.editoptions.custom_value.call(p,a(".customelement",this),"get"),void 0===q[r])throw"e2";}else throw"e1";}catch(e){"e1"===e&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===e?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}w=a.jgrid.checkValues.call(p,q[r],b);if(!1===w[0])return!1;p.p.autoencode&&
    (q[r]=a.jgrid.htmlEncode(q[r]));"clientArray"!==l.url&&x.editoptions&&!0===x.editoptions.NullIfEmpty&&""===q[r]&&(t[r]="null")}});if(!1===w[0]){try{var y=a(p).jqGrid("getGridRowById",d),A=a.jgrid.findPos(y);a.jgrid.info_dialog(a.jgrid.errors.errcap,w[1],a.jgrid.edit.bClose,{left:A[0],top:A[1]+a(y).outerHeight()})}catch(B){alert(w[1])}return m}k=p.p.prmNames;y=d;A=!1===p.p.keyIndex?k.id:p.p.colModel[p.p.keyIndex+(!0===p.p.rownumbers?1:0)+(!0===p.p.multiselect?1:0)+(!0===p.p.subGrid?1:0)].name;q&&(q[k.oper]=
        k.editoper,void 0===q[A]||""===q[A]?q[A]=d:u.id!==p.p.idPrefix+q[A]&&(k=a.jgrid.stripPref(p.p.idPrefix,d),void 0!==p.p._index[k]&&(p.p._index[q[A]]=p.p._index[k],delete p.p._index[k]),d=p.p.idPrefix+q[A],a(u).attr("id",d),p.p.selrow===y&&(p.p.selrow=d),a.isArray(p.p.selarrrow)&&(k=a.inArray(y,p.p.selarrrow),0<=k&&(p.p.selarrrow[k]=d)),p.p.multiselect&&(k="jqg_"+p.p.id+"_"+d,a("input.cbox",u).attr("id",k).attr("name",k))),void 0===p.p.inlineData&&(p.p.inlineData={}),q=a.extend({},q,p.p.inlineData,
        l.extraparam));if("clientArray"===l.url){q=a.extend({},q,n);p.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});k=a(p).jqGrid("setRowData",d,q);a(u).attr("editable","0");for(A=0;A<p.p.savedRow.length;A++)if(String(p.p.savedRow[A].id)===String(y)){v=A;break}0<=v&&p.p.savedRow.splice(v,1);a(p).triggerHandler("jqGridInlineAfterSaveRow",[d,k,q,l]);a.isFunction(l.aftersavefunc)&&l.aftersavefunc.call(p,d,k,l);m=!0;a(u).removeClass("jqgrid-new-row").unbind("keydown")}else a("#lui_"+a.jgrid.jqID(p.p.id)).show(),
        t=a.extend({},q,t),t[A]=a.jgrid.stripPref(p.p.idPrefix,t[A]),a.ajax(a.extend({url:l.url,data:a.isFunction(p.p.serializeRowData)?p.p.serializeRowData.call(p,t):t,type:l.mtype,async:!1,complete:function(b,c){a("#lui_"+a.jgrid.jqID(p.p.id)).hide();if("success"===c){var e=!0,f;f=a(p).triggerHandler("jqGridInlineSuccessSaveRow",[b,d,l]);a.isArray(f)||(f=[!0,q]);f[0]&&a.isFunction(l.successfunc)&&(f=l.successfunc.call(p,b));a.isArray(f)?(e=f[0],q=f[1]||q):e=f;if(!0===e){p.p.autoencode&&a.each(q,function(b,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               c){q[b]=a.jgrid.htmlDecode(c)});q=a.extend({},q,n);a(p).jqGrid("setRowData",d,q);a(u).attr("editable","0");for(e=0;e<p.p.savedRow.length;e++)if(String(p.p.savedRow[e].id)===String(d)){v=e;break}0<=v&&p.p.savedRow.splice(v,1);a(p).triggerHandler("jqGridInlineAfterSaveRow",[d,b,q,l]);a.isFunction(l.aftersavefunc)&&l.aftersavefunc.call(p,d,b);m=!0;a(u).removeClass("jqgrid-new-row").unbind("keydown")}else a(p).triggerHandler("jqGridInlineErrorSaveRow",[d,b,c,null,l]),a.isFunction(l.errorfunc)&&l.errorfunc.call(p,
...
(h=a.jgrid.htmlDecode(h));k.edittype||(k.edittype="text");f.p.savedRow.push({id:d,ic:e,name:c,v:h});if("&nbsp;"===h||"&#160;"===h||1===h.length&&160===h.charCodeAt(0))h="";if(a.isFunction(f.p.formatCell)){var m=f.p.formatCell.call(f,f.rows[d].id,c,h,d,e);void 0!==m&&(h=m)}a(f).triggerHandler("jqGridBeforeEditCell",[f.rows[d].id,c,h,d,e]);a.isFunction(f.p.beforeEditCell)&&f.p.beforeEditCell.call(f,f.rows[d].id,c,h,d,e);var m=a.extend({},k.editoptions||{},{id:d+"_"+c,name:c}),p=a.jgrid.createEl.call(f,
    ...
    b.rows[d].id,l,h,d,e))||(f={}));0<a("input.hasDatepicker",c).length&&a("input.hasDatepicker",c).datepicker("hide");if("remote"===b.p.cellsubmit)if(b.p.cellurl){var t={};b.p.autoencode&&(h=a.jgrid.htmlEncode(h));t[l]=h;r=b.p.prmNames;k=r.id;m=r.oper;t[k]=a.jgrid.stripPref(b.p.idPrefix,b.rows[d].id);t[m]=r.editoper;t=a.extend(f,t);a("#lui_"+a.jgrid.jqID(b.p.id)).show();b.grid.hDiv.loading=!0;a.ajax(a.extend({url:b.p.cellurl,data:a.isFunction(b.p.serializeCellData)?b.p.serializeCellData.call(b,t):t,
        type:"POST",complete:function(f,k){a("#lui_"+b.p.id).hide();b.grid.hDiv.loading=!1;if("success"===k){var m=a(b).triggerHandler("jqGridAfterSubmitCell",[b,f,t.id,l,h,d,e])||[!0,""];!0===m[0]&&a.isFunction(b.p.afterSubmitCell)&&(m=b.p.afterSubmitCell.call(b,f,t.id,l,h,d,e));!0===m[0]?(a(c).empty(),a(b).jqGrid("setCell",b.rows[d].id,e,g,!1,!1,!0),a(c).addClass("dirty-cell"),a(b.rows[d]).addClass("edited"),a(b).triggerHandler("jqGridAfterSaveCell",[b.rows[d].id,l,h,d,e]),a.isFunction(b.p.afterSaveCell)&&
...
(function(a){a.jgrid.extend({setSubGrid:function(){return this.each(function(){var d,e;this.p.subGridOptions=a.extend({plusicon:"ui-icon-plus",minusicon:"ui-icon-minus",openicon:"ui-icon-carat-1-sw",expandOnLoad:!1,delayOnLoad:50,selectOnExpand:!1,selectOnCollapse:!1,reloadOnExpand:!0},this.p.subGridOptions||{});this.p.colNames.unshift("");this.p.colModel.unshift({name:"subgrid",width:a.jgrid.cell_width?this.p.subGridWidth+this.p.cellLayout:this.p.subGridWidth,sortable:!1,resizable:!1,hidedlg:!0,
    ...
    if(b.p.subGridModel[0].params)for(k=0;k<b.p.subGridModel[0].params.length;k++)for(g=0;g<b.p.colModel.length;g++)b.p.colModel[g].name===b.p.subGridModel[0].params[k]&&(f[b.p.colModel[g].name]=a("td:eq("+g+")",d).text().replace(/\&#160\;/ig,""));if(!b.grid.hDiv.loading)switch(b.grid.hDiv.loading=!0,a("#load_"+a.jgrid.jqID(b.p.id)).show(),b.p.subgridtype||(b.p.subgridtype=b.p.datatype),a.isFunction(b.p.subgridtype)?b.p.subgridtype.call(b,f):b.p.subgridtype=b.p.subgridtype.toLowerCase(),b.p.subgridtype){case "xml":case "json":a.ajax(a.extend({type:b.p.mtype,
        url:b.p.subGridUrl,dataType:b.p.subgridtype,data:a.isFunction(b.p.serializeSubGridData)?b.p.serializeSubGridData.call(b,f):f,complete:function(d){"xml"===b.p.subgridtype?c(d.responseXML,e):h(a.jgrid.parse(d.responseText),e)}},a.jgrid.ajaxOptions,b.p.ajaxSubgridOptions||{}))}return!1},k,l,m,p=0,r,q;a.each(b.p.colModel,function(){!0!==this.hidden&&"rn"!==this.name&&"cb"!==this.name||p++});var n=b.rows.length,t=1;void 0!==e&&0<e&&(t=e,n=e+1);for(;t<n;)a(b.rows[t]).hasClass("jqgrow")&&a(b.rows[t].cells[d]).bind("click",
...
d.p.rowTotal&&(d.p.rowNum=1E4);d.p.multiselect=!1;d.p.rowList=[];d.p.expColInd=0;b="ui-icon-triangle-1-"+("rtl"===d.p.direction?"w":"e");d.p.treeIcons=a.extend({plus:b,minus:"ui-icon-triangle-1-s",leaf:"ui-icon-radio-off"},d.p.treeIcons||{});"nested"===d.p.treeGridModel?d.p.treeReader=a.extend({level_field:"level",left_field:"lft",right_field:"rgt",leaf_field:"isLeaf",expanded_field:"expanded",loaded:"loaded",icon_field:"icon"},d.p.treeReader):"adjacency"===d.p.treeGridModel&&(d.p.treeReader=a.extend({level_field:"level",
    ...
    if(this.grid&&this.p.treeGrid&&(b=this.p._index[d],void 0!==b)){h=parseInt(this.p.data[b][c],10);g=h-parseInt(this.p.data[b][f],10)+1;var l=a(this).jqGrid("getFullTreeNode",this.p.data[b]);if(0<l.length)for(b=0;b<l.length;b++)a(this).jqGrid("delRowData",l[b][e]);if("nested"===this.p.treeGridModel){e=a.jgrid.from(this.p.data).greater(f,h,{stype:"integer"}).select();if(e.length)for(k in e)e.hasOwnProperty(k)&&(e[k][f]=parseInt(e[k][f],10)-g);e=a.jgrid.from(this.p.data).greater(c,h,{stype:"integer"}).select();
        if(e.length)for(k in e)e.hasOwnProperty(k)&&(e[k][c]=parseInt(e[k][c],10)-g)}}})},addChildNode:function(d,e,b,f){var c=this[0];if(b){var h=c.p.treeReader.expanded_field,g=c.p.treeReader.leaf_field,k=c.p.treeReader.level_field,l=c.p.treeReader.parent_id_field,m=c.p.treeReader.left_field,p=c.p.treeReader.right_field,r=c.p.treeReader.loaded,q,n,t,v,w;q=0;var u=e,x;void 0===f&&(f=!1);if(void 0===d||null===d){w=c.p.data.length-1;if(0<=w)for(;0<=w;)q=Math.max(q,parseInt(c.p.data[w][c.p.localReader.id],
    10)),w--;d=q+1}var y=a(c).jqGrid("getInd",e);x=!1;void 0===e||null===e||""===e?(u=e=null,q="last",v=c.p.tree_root_level,w=c.p.data.length+1):(q="after",n=c.p._index[e],t=c.p.data[n],e=t[c.p.localReader.id],v=parseInt(t[k],10)+1,w=a(c).jqGrid("getFullTreeNode",t),w.length?(u=w=w[w.length-1][c.p.localReader.id],w=a(c).jqGrid("getInd",u)+1):w=a(c).jqGrid("getInd",e)+1,t[g]&&(x=!0,t[h]=!0,a(c.rows[y]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(c.p.treeIcons.leaf+
    " tree-leaf").addClass(c.p.treeIcons.minus+" tree-minus"),c.p.data[n][g]=!1,t[r]=!0));n=w+1;void 0===b[h]&&(b[h]=!1);void 0===b[r]&&(b[r]=!1);b[k]=v;void 0===b[g]&&(b[g]=!0);"adjacency"===c.p.treeGridModel&&(b[l]=e);if("nested"===c.p.treeGridModel){var A;if(null!==e){g=parseInt(t[p],10);k=a.jgrid.from(c.p.data);k=k.greaterOrEquals(p,g,{stype:"integer"});k=k.select();if(k.length)for(A in k)k.hasOwnProperty(A)&&(k[A][m]=k[A][m]>g?parseInt(k[A][m],10)+2:k[A][m],k[A][p]=k[A][p]>=g?parseInt(k[A][p],10)+
2:k[A][p]);b[m]=g;b[p]=g+1}else{g=parseInt(a(c).jqGrid("getCol",p,!1,"max"),10);k=a.jgrid.from(c.p.data).greater(m,g,{stype:"integer"}).select();if(k.length)for(A in k)k.hasOwnProperty(A)&&(k[A][m]=parseInt(k[A][m],10)+2);k=a.jgrid.from(c.p.data).greater(p,g,{stype:"integer"}).select();if(k.length)for(A in k)k.hasOwnProperty(A)&&(k[A][p]=parseInt(k[A][p],10)+2);b[m]=g+1;b[p]=g+2}}if(null===e||a(c).jqGrid("isNodeLoaded",t)||x)a(c).jqGrid("addRowData",d,b,q,u),a(c).jqGrid("setTreeNode",w,n);t&&!t[h]&&
f&&a(c.rows[y]).find("div.treeclick").click()}}})})(jQuery);
...
(this.sd&&this.vd?this.v/=this.vd:this.v&&0<n&&(this.v/=n));try{this.groupCount=k.cnt,this.groupIndex=k.dataIndex,this.groupValue=k.value,m=g.formatter("",this.v,p,this)}catch(b){m=this.v}q="<td "+g.formatCol(p,1,"")+">"+a.jgrid.format(r,m)+"</td>";return!1}});b+=q}return b}var g=this,k=g.p.groupingView,l="",m="",p,r,q=k.groupCollapse?k.plusicon:k.minusicon,n,t=[],v=k.groupField.length,q=q+(" tree-wrap-"+g.p.direction);a.each(g.p.colModel,function(a,b){var c;for(c=0;c<v;c++)if(k.groupField[c]===b.name){t[c]=
    a;break}});var w=0,u=a.makeArray(k.groupSummary);u.reverse();a.each(k.groups,function(c,y){if(k._locgr&&!(y.startRow+y.cnt>(b-1)*f&&y.startRow<b*f))return!0;w++;r=g.p.id+"ghead_"+y.idx;p=r+"_"+c;m="<span style='cursor:pointer;' class='ui-icon "+q+"' onclick=\"jQuery('#"+a.jgrid.jqID(g.p.id)+"').jqGrid('groupingToggle','"+p+"');return false;\"></span>";try{a.isArray(k.formatDisplayField)&&a.isFunction(k.formatDisplayField[y.idx])?(y.displayValue=k.formatDisplayField[y.idx].call(g,y.displayValue,y.value,
    g.p.colModel[t[y.idx]],y.idx,k),n=y.displayValue):n=g.formatter(p,y.displayValue,t[y.idx],y.value)}catch(A){n=y.displayValue}"header"===k.groupSummaryPos[y.idx]?(l+='<tr id="'+p+'"'+(k.groupCollapse&&0<y.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+g.p.direction+" "+r+'"><td style="padding-left:'+12*y.idx+'px;">'+m+a.jgrid.template(k.groupText[y.idx],n,y.cnt,y.summary)+"</td>",l+=h(c,y.idx-1,k.groups,1),l+="</tr>"):l+='<tr id="'+p+'"'+(k.groupCollapse&&
    0<y.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+g.p.direction+" "+r+'"><td style="padding-left:'+12*y.idx+'px;" colspan="'+e+'">'+m+a.jgrid.template(k.groupText[y.idx],n,y.cnt,y.summary)+"</td></tr>";if(v-1===y.idx){var B=k.groups[c+1],J,C=0;J=y.startRow;var M=void 0!==B?k.groups[c+1].startRow:d.length;k._locgr&&(C=(b-1)*f,C>y.startRow&&(J=C));for(;J<M&&d[J-C];J++)l+=d[J-C].join("");if("header"!==k.groupSummaryPos[y.idx]){var H;if(void 0!==B){for(H=0;H<
k.groupField.length&&B.dataIndex!==k.groupField[H];H++);w=k.groupField.length-H}for(B=0;B<w;B++)u[B]&&(C="",k.groupCollapse&&!k.showSummaryOnHide&&(C=' style="display:none;"'),l+="<tr"+C+' jqfootlevel="'+(y.idx-B)+'" role="row" class="ui-widget-content jqfoot ui-row-'+g.p.direction+'">',l+=h(c,B,k.groups,0),l+="</tr>");w=H}}});a("#"+a.jgrid.jqID(g.p.id)+" tbody:first").append(l);l=null})},groupingGroupBy:function(d,e){return this.each(function(){"string"===typeof d&&(d=[d]);var b=this.p.groupingView;
...
d._start_.apply(this,[f,c])},d.update=function(f,c){a(c.item).css("border-width","");!0===b.p.rownumbers&&a("td.jqgrid-rownum",b.rows).each(function(c){a(this).html(c+1+(parseInt(b.p.page,10)-1)*parseInt(b.p.rowNum,10))});d._update_&&d._update_.apply(this,[f,c])},a("tbody:first",b).sortable(d),a("tbody:first",b).disableSelection())})},gridDnD:function(d){return this.each(function(){function b(){var b=a.data(f,"dnd");a("tr.jqgrow:not(.ui-draggable)",f).draggable(a.isFunction(b.drag)?b.drag.call(a(f),
    b):b.drag)}var f=this,c,h;if(f.grid&&!f.p.treeGrid&&a.fn.draggable&&a.fn.droppable)if(void 0===a("#jqgrid_dnd")[0]&&a("body").append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"),"string"===typeof d&&"updateDnD"===d&&!0===f.p.jqgdnd)b();else if(d=a.extend({drag:function(b){return a.extend({start:function(c,d){var e;if(f.p.subGrid){e=a(d.helper).attr("id");try{a(f).jqGrid("collapseSubGridRow",e)}catch(h){}}for(e=0;e<a.data(f,"dnd").connectWith.length;e++)0===a(a.data(f,"dnd").connectWith[e]).jqGrid("getGridParam",
        ...
        e);if(!b.dropbyname){var h=0,r={},q,n,t=a("#"+a.jgrid.jqID(this.id)).jqGrid("getGridParam","colModel");try{for(n in e)e.hasOwnProperty(n)&&(q=t[h].name,"cb"!==q&&"rn"!==q&&"subgrid"!==q&&e.hasOwnProperty(n)&&t[h]&&(r[q]=e[n]),h++);e=r}catch(v){}}d.helper.dropped=!0;b.beforedrop&&a.isFunction(b.beforedrop)&&(q=b.beforedrop.call(this,c,d,e,a("#"+a.jgrid.jqID(f.p.id)),a(this)),void 0!==q&&null!==q&&"object"===typeof q&&(e=q));if(d.helper.dropped){var w;b.autoid&&(a.isFunction(b.autoid)?w=b.autoid.call(this,
        e):(w=Math.ceil(1E3*Math.random()),w=b.autoidprefix+w));a("#"+a.jgrid.jqID(this.id)).jqGrid("addRowData",w,e,b.droppos)}b.ondrop&&a.isFunction(b.ondrop)&&b.ondrop.call(this,c,d,e)}}},b.drop_opts||{})},onstart:null,onstop:null,beforedrop:null,ondrop:null,drop_opts:{activeClass:"ui-state-active",hoverClass:"ui-state-hover"},drag_opts:{revert:"invalid",helper:"clone",cursor:"move",appendTo:"#jqgrid_dnd",zIndex:5E3},dragcopy:!1,dropbyname:!1,droppos:"first",autoid:!0,autoidprefix:"dnd_"},d||{}),d.connectWith)for(d.connectWith=
...
(function(a){function d(a,b){var d,c,h=[],g;if(!this||"function"!==typeof a||a instanceof RegExp)throw new TypeError;g=this.length;for(d=0;d<g;d++)if(this.hasOwnProperty(d)&&(c=this[d],a.call(b,c,d,this))){h.push(c);break}return h}a.assocArraySize=function(a){var b=0,d;for(d in a)a.hasOwnProperty(d)&&b++;return b};a.jgrid.extend({pivotSetup:function(e,b){var f=[],c=[],h=[],g=[],k={grouping:!0,groupingView:{groupField:[],groupSummary:[],groupSummaryPos:[]}},l=[],m=a.extend({rowTotals:!1,rowTotalsText:"Total",
    ...
    1===f?p:p+"_"+c[h].aggregator+"_"+h}catch(q){}}var r=k,t=n,v=k,u=e[k],w=c[h].member,x=b,y=void 0;switch(c[h].aggregator){case "sum":y=parseFloat(u||0)+parseFloat(x[w]||0);break;case "count":if(""===u||null==u)u=0;y=x.hasOwnProperty(w)?u+1:0;break;case "min":y=""===u||null==u?parseFloat(x[w]||0):Math.min(parseFloat(u),parseFloat(x[w]||0));break;case "max":y=""===u||null==u?parseFloat(x[w]||0):Math.max(parseFloat(u),parseFloat(x[w]||0))}e[r]=t[v]=y}g[p]=n}return e}function n(a){var b,c,d,e,g;for(d in a)if(a.hasOwnProperty(d)){if("object"!==
    typeof a[d]&&("level"===d&&(void 0===Q[a.level]&&(Q[a.level]="",0<a.level&&"_r_Totals"!==a.text&&(l[a.level-1]={useColSpanStyle:!1,groupHeaders:[]})),Q[a.level]!==a.text&&a.children.length&&"_r_Totals"!==a.text&&0<a.level&&(l[a.level-1].groupHeaders.push({titleText:a.text}),c=l[a.level-1].groupHeaders.length,g=1===c?Y:W+(c-1)*A,l[a.level-1].groupHeaders[c-1].startColumnName=f[g].name,l[a.level-1].groupHeaders[c-1].numberOfColumns=f.length-g,W=f.length),Q[a.level]=a.text),a.level===y&&"level"===d&&
    0<y))if(1<A){c=1;for(b in a.fields)1===c&&l[y-1].groupHeaders.push({startColumnName:b,numberOfColumns:1,titleText:a.text}),c++;l[y-1].groupHeaders[l[y-1].groupHeaders.length-1].numberOfColumns=c-1}else l.splice(y-1,1);null!=a[d]&&"object"===typeof a[d]&&n(a[d]);if("level"===d&&0<a.level)for(b in c=0,a.fields){g={};for(e in m.aggregates[c])if(m.aggregates[c].hasOwnProperty(e))switch(e){case "member":case "label":case "aggregator":break;default:g[e]=m.aggregates[c][e]}1<A?(g.name=b,g.label=m.aggregates[c].label||
    b):(g.name=a.text,g.label="_r_Totals"===a.text?m.rowTotalsText:a.text);f.push(g);c++}}}var t,v,w,u=e.length,x,y,A,B,J=0;m.rowTotals&&0<m.yDimension.length&&(m.yDimension.splice(0,0,{dataName:m.yDimension[0].dataName}),m.yDimension[0].converter=function(){return"_r_Totals"});x=a.isArray(m.xDimension)?m.xDimension.length:0;y=m.yDimension.length;A=a.isArray(m.aggregates)?m.aggregates.length:0;if(0===x||0===A)throw"xDimension or aggregates optiona are not set!";var C;for(w=0;w<x;w++)C={name:m.xDimension[w].dataName,
    frozen:m.frozenStaticCols},C=a.extend(!0,C,m.xDimension[w]),f.push(C);C=x-1;for(var M={};J<u;){t=e[J];var H=[],z=[];B={};w=0;do H[w]=a.trim(t[m.xDimension[w].dataName]),B[m.xDimension[w].dataName]=H[w],w++;while(w<x);var E=0;v=-1;w=b(c,r,H);if(!w){E=0;if(1<=y){for(E=0;E<y;E++)z[E]=a.trim(t[m.yDimension[E].dataName]),m.yDimension[E].converter&&a.isFunction(m.yDimension[E].converter)&&(z[E]=m.yDimension[E].converter.call(this,z[E],H,z));B=q(t,m.aggregates,z,B)}else 0===y&&(B=q(t,m.aggregates,null,B));
    c.push(B)}else if(0<=v){E=0;if(1<=y){for(E=0;E<y;E++)z[E]=a.trim(t[m.yDimension[E].dataName]),m.yDimension[E].converter&&a.isFunction(m.yDimension[E].converter)&&(z[E]=m.yDimension[E].converter.call(this,z[E],H,z));w=q(t,m.aggregates,z,w)}else 0===y&&(w=q(t,m.aggregates,null,w));c[v]=w}t=0;var H=B=null,D;for(D in g){if(0===t)M.children&&void 0!==M.children||(M={text:D,level:0,children:[]}),B=M.children;else{H=null;for(w=0;w<B.length;w++)if(B[w].text===D){H=B[w];break}H?B=H.children:(B.push({children:[],
    text:D,level:t,fields:g[D]}),B=B[B.length-1].children)}t++}J++}var Q=[],W=f.length,Y=W;0<y&&(l[y-1]={useColSpanStyle:!1,groupHeaders:[]});n(M,0);if(m.colTotals)for(J=c.length;J--;)for(w=x;w<f.length;w++)u=f[w].name,h[u]=h[u]?h[u]+parseFloat(c[J][u]||0):parseFloat(c[J][u]||0);if(0<C)for(w=0;w<C;w++)k.groupingView.groupField[w]=f[w].name,k.groupingView.groupSummary[w]=m.groupSummary,k.groupingView.groupSummaryPos[w]=m.groupSummaryPos;else k.grouping=!1;k.sortname=f[C].name;k.groupingView.hideFirstGroupCol=
